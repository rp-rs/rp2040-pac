#[doc = "Reader of register SWCLK"]
pub type R = crate::R<u32, super::SWCLK>;
#[doc = "Writer for register SWCLK"]
pub type W = crate::W<u32, super::SWCLK>;
#[doc = "Register SWCLK `reset()`'s with value 0xda"]
impl crate::ResetValue for super::SWCLK {
    type Type = u32;
    #[inline(always)]
