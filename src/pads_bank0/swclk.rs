...
pub struct R(crate::R<SWCLK_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SWCLK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SWCLK_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SWCLK_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SWCLK` writer"]
pub struct W(crate::W<SWCLK_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SWCLK_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SWCLK_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SWCLK_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SLEWFAST_W<'a, const O: u8> = crate::BitWriter<'a, u32, SWCLK_SPEC, bool, O>;
...
pub type DRIVE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u32, SWCLK_SPEC, u8, DRIVE_A, 2, O>;
...
pub type IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, SWCLK_SPEC, bool, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, SWCLK_SPEC, bool, O>;
impl R {
...
For information about available fields see [swclk](index.html) module"]
...
impl crate::Resettable for SWCLK_SPEC {
    const RESET_VALUE: Self::Ux = 0xda;
}
