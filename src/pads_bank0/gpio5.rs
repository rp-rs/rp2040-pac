#[doc = "Reader of register GPIO5"]
pub type R = crate::R<u32, super::GPIO5>;
#[doc = "Writer for register GPIO5"]
pub type W = crate::W<u32, super::GPIO5>;
#[doc = "Register GPIO5 `reset()`'s with value 0x56"]
impl crate::ResetValue for super::GPIO5 {
    type Type = u32;
    #[inline(always)]
