#[doc = "Reader of register GPIO7"]
pub type R = crate::R<u32, super::GPIO7>;
#[doc = "Writer for register GPIO7"]
pub type W = crate::W<u32, super::GPIO7>;
#[doc = "Register GPIO7 `reset()`'s with value 0x56"]
impl crate::ResetValue for super::GPIO7 {
    type Type = u32;
    #[inline(always)]
