#[doc = "Reader of register GPIO6"]
pub type R = crate::R<u32, super::GPIO6>;
#[doc = "Writer for register GPIO6"]
pub type W = crate::W<u32, super::GPIO6>;
#[doc = "Register GPIO6 `reset()`'s with value 0x56"]
impl crate::ResetValue for super::GPIO6 {
    type Type = u32;
    #[inline(always)]
