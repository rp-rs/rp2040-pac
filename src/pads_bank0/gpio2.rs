#[doc = "Reader of register GPIO2"]
pub type R = crate::R<u32, super::GPIO2>;
#[doc = "Writer for register GPIO2"]
pub type W = crate::W<u32, super::GPIO2>;
#[doc = "Register GPIO2 `reset()`'s with value 0x56"]
impl crate::ResetValue for super::GPIO2 {
    type Type = u32;
    #[inline(always)]
