#[doc = "Reader of register GPIO4"]
pub type R = crate::R<u32, super::GPIO4>;
#[doc = "Writer for register GPIO4"]
pub type W = crate::W<u32, super::GPIO4>;
#[doc = "Register GPIO4 `reset()`'s with value 0x56"]
impl crate::ResetValue for super::GPIO4 {
    type Type = u32;
    #[inline(always)]
