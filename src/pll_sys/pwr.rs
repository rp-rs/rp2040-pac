...
#[doc = "Field `DSMPD` writer - PLL DSM powerdown  
 Nothing is achieved by setting this low."]
pub type DSMPD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
#[doc = "Field `POSTDIVPD` writer - PLL post divider powerdown  
 To save power set high when PLL output not required or bypass=1."]
pub type POSTDIVPD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
#[doc = "Field `VCOPD` reader - PLL VCO powerdown  
 To save power set high when PLL output not required or bypass=1."]
pub type VCOPD_R = crate::BitReader;
#[doc = "Field `VCOPD` writer - PLL VCO powerdown  
 To save power set high when PLL output not required or bypass=1."]
pub type VCOPD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
 ...
 To save power set high when PLL output not required."]
    #[inline(always)]
    #[must_use]
    pub fn pd(&mut self) -> PD_W<PWR_SPEC, 0> {
        PD_W::new(self)
    }
    #[doc = "Bit 2 - PLL DSM powerdown  
 Nothing is achieved by setting this low."]
    #[inline(always)]
    #[must_use]
    pub fn dsmpd(&mut self) -> DSMPD_W<PWR_SPEC, 2> {
        DSMPD_W::new(self)
    }
    #[doc = "Bit 3 - PLL post divider powerdown  
 To save power set high when PLL output not required or bypass=1."]
    #[inline(always)]
    #[must_use]
    pub fn postdivpd(&mut self) -> POSTDIVPD_W<PWR_SPEC, 3> {
 ...
 To save power set high when PLL output not required or bypass=1."]
    #[inline(always)]
    #[must_use]
    pub fn vcopd(&mut self) -> VCOPD_W<PWR_SPEC, 5> {
        VCOPD_W::new(self)
    }
