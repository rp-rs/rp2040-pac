...
pub type ACK_GEN_CALL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, ACK_GEN_CALL_A>;
impl<'a, REG, const O: u8> ACK_GEN_CALL_W<'a, REG, O>
where
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ack_gen_call(&mut self) -> ACK_GEN_CALL_W<IC_ACK_GENERAL_CALL_SPEC, 0> {
