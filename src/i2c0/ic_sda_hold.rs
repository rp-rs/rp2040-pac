...
#[doc = "Field `IC_SDA_TX_HOLD` writer - Sets the required SDA hold time in units of ic_clk period, when DW_apb_i2c acts as a transmitter.  
 ...
 Reset value: IC_DEFAULT_SDA_HOLD\\[15:0\\]."]
pub type IC_SDA_TX_HOLD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
...
#[doc = "Field `IC_SDA_RX_HOLD` writer - Sets the required SDA hold time in units of ic_clk period, when DW_apb_i2c acts as a receiver.  
 ...
 Reset value: IC_DEFAULT_SDA_HOLD\\[23:16\\]."]
pub type IC_SDA_RX_HOLD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O>;
impl R {
...
impl W {
 ...
 Reset value: IC_DEFAULT_SDA_HOLD\\[15:0\\]."]
    #[inline(always)]
    #[must_use]
    pub fn ic_sda_tx_hold(&mut self) -> IC_SDA_TX_HOLD_W<IC_SDA_HOLD_SPEC, 0> {
 ...
 Reset value: IC_DEFAULT_SDA_HOLD\\[23:16\\]."]
    #[inline(always)]
    #[must_use]
    pub fn ic_sda_rx_hold(&mut self) -> IC_SDA_RX_HOLD_W<IC_SDA_HOLD_SPEC, 16> {
