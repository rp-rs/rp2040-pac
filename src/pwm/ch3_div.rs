#[doc = "Reader of register CH3_DIV"]
pub type R = crate::R<u32, super::CH3_DIV>;
#[doc = "Writer for register CH3_DIV"]
pub type W = crate::W<u32, super::CH3_DIV>;
#[doc = "Register CH3_DIV `reset()`'s with value 0x10"]
impl crate::ResetValue for super::CH3_DIV {
    type Type = u32;
    #[inline(always)]
