#[doc = "Reader of register CH0_DIV"]
pub type R = crate::R<u32, super::CH0_DIV>;
#[doc = "Writer for register CH0_DIV"]
pub type W = crate::W<u32, super::CH0_DIV>;
#[doc = "Register CH0_DIV `reset()`'s with value 0x10"]
impl crate::ResetValue for super::CH0_DIV {
    type Type = u32;
    #[inline(always)]
