#[doc = "Reader of register CH6_DIV"]
pub type R = crate::R<u32, super::CH6_DIV>;
#[doc = "Writer for register CH6_DIV"]
pub type W = crate::W<u32, super::CH6_DIV>;
#[doc = "Register CH6_DIV `reset()`'s with value 0x10"]
impl crate::ResetValue for super::CH6_DIV {
    type Type = u32;
    #[inline(always)]
