#[doc = "Reader of register CH5_DIV"]
pub type R = crate::R<u32, super::CH5_DIV>;
#[doc = "Writer for register CH5_DIV"]
pub type W = crate::W<u32, super::CH5_DIV>;
#[doc = "Register CH5_DIV `reset()`'s with value 0x10"]
impl crate::ResetValue for super::CH5_DIV {
    type Type = u32;
    #[inline(always)]
