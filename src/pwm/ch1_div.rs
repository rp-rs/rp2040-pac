#[doc = "Reader of register CH1_DIV"]
pub type R = crate::R<u32, super::CH1_DIV>;
#[doc = "Writer for register CH1_DIV"]
pub type W = crate::W<u32, super::CH1_DIV>;
#[doc = "Register CH1_DIV `reset()`'s with value 0x10"]
impl crate::ResetValue for super::CH1_DIV {
    type Type = u32;
    #[inline(always)]
