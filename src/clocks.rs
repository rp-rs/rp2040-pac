...
#[doc = "CLK_GPOUT0_CTRL (rw) register accessor: an alias for `Reg<CLK_GPOUT0_CTRL_SPEC>`"]
...
#[doc = "CLK_GPOUT0_DIV (rw) register accessor: an alias for `Reg<CLK_GPOUT0_DIV_SPEC>`"]
...
#[doc = "CLK_GPOUT0_SELECTED (r) register accessor: an alias for `Reg<CLK_GPOUT0_SELECTED_SPEC>`"]
...
pub mod fc0_min_khz;
#[doc = "FC0_MAX_KHZ (rw) register accessor: an alias for `Reg<FC0_MAX_KHZ_SPEC>`"]
...
pub mod fc0_max_khz;
#[doc = "FC0_DELAY (rw) register accessor: an alias for `Reg<FC0_DELAY_SPEC>`"]
...
#[doc = "Delays the start of frequency counting to allow the mux to settle  
 Delay is measured in multiples of the reference clock period"]
pub mod fc0_delay;
#[doc = "FC0_INTERVAL (rw) register accessor: an alias for `Reg<FC0_INTERVAL_SPEC>`"]
...
#[doc = "FC0_SRC (rw) register accessor: an alias for `Reg<FC0_SRC_SPEC>`"]
pub type FC0_SRC = crate::Reg<fc0_src::FC0_SRC_SPEC>;
#[doc = "Clock sent to frequency counter, set to 0 when not required  
 Writing to this register initiates the frequency count"]
pub mod fc0_src;
#[doc = "FC0_STATUS (r) register accessor: an alias for `Reg<FC0_STATUS_SPEC>`"]
pub type FC0_STATUS = crate::Reg<fc0_status::FC0_STATUS_SPEC>;
#[doc = "Frequency counter status"]
pub mod fc0_status;
#[doc = "FC0_RESULT (r) register accessor: an alias for `Reg<FC0_RESULT_SPEC>`"]
...
pub mod fc0_result;
#[doc = "WAKE_EN0 (rw) register accessor: an alias for `Reg<WAKE_EN0_SPEC>`"]
pub type WAKE_EN0 = crate::Reg<wake_en0::WAKE_EN0_SPEC>;
#[doc = "enable clock in wake mode"]
pub mod wake_en0;
#[doc = "WAKE_EN1 (rw) register accessor: an alias for `Reg<WAKE_EN1_SPEC>`"]
pub type WAKE_EN1 = crate::Reg<wake_en1::WAKE_EN1_SPEC>;
#[doc = "enable clock in wake mode"]
pub mod wake_en1;
#[doc = "SLEEP_EN0 (rw) register accessor: an alias for `Reg<SLEEP_EN0_SPEC>`"]
pub type SLEEP_EN0 = crate::Reg<sleep_en0::SLEEP_EN0_SPEC>;
#[doc = "enable clock in sleep mode"]
pub mod sleep_en0;
#[doc = "SLEEP_EN1 (rw) register accessor: an alias for `Reg<SLEEP_EN1_SPEC>`"]
pub type SLEEP_EN1 = crate::Reg<sleep_en1::SLEEP_EN1_SPEC>;
#[doc = "enable clock in sleep mode"]
pub mod sleep_en1;
#[doc = "ENABLED0 (r) register accessor: an alias for `Reg<ENABLED0_SPEC>`"]
pub type ENABLED0 = crate::Reg<enabled0::ENABLED0_SPEC>;
#[doc = "indicates the state of the clock enable"]
pub mod enabled0;
#[doc = "ENABLED1 (r) register accessor: an alias for `Reg<ENABLED1_SPEC>`"]
