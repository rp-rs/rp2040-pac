...
pub type PERFSEL1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O, PERFSEL1_A>;
impl<'a, REG, const O: u8> PERFSEL1_W<'a, REG, O>
where
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn perfsel1(&mut self) -> PERFSEL1_W<PERFSEL1_SPEC, 0> {
        PERFSEL1_W::new(self)
    }
