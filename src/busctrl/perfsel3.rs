...
pub type PERFSEL3_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O, PERFSEL3_A>;
impl<'a, REG, const O: u8> PERFSEL3_W<'a, REG, O>
where
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn perfsel3(&mut self) -> PERFSEL3_W<PERFSEL3_SPEC, 0> {
        PERFSEL3_W::new(self)
    }
