...
#[doc = "CHIP_ID (r) register accessor: an alias for `Reg<CHIP_ID_SPEC>`"]
pub type CHIP_ID = crate::Reg<chip_id::CHIP_ID_SPEC>;
#[doc = "JEDEC JEP-106 compliant chip identifier."]
pub mod chip_id;
#[doc = "PLATFORM (r) register accessor: an alias for `Reg<PLATFORM_SPEC>`"]
...
pub mod platform;
#[doc = "GITREF_RP2040 (r) register accessor: an alias for `Reg<GITREF_RP2040_SPEC>`"]
