...
pub struct R(crate::R<CLK_PERI_SELECTED_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CLK_PERI_SELECTED_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CLK_PERI_SELECTED_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CLK_PERI_SELECTED_SPEC>) -> Self {
        R(reader)
    }
}
...
impl core::fmt::Debug for crate::generic::Reg<CLK_PERI_SELECTED_SPEC> {
...
For information about available fields see [clk_peri_selected](index.html) module"]
