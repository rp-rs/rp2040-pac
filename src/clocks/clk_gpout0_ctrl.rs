...
pub type AUXSRC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLK_GPOUT0_CTRL_SPEC, u8, AUXSRC_A, 4, O>;
...
pub type KILL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLK_GPOUT0_CTRL_SPEC, bool, O>;
...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLK_GPOUT0_CTRL_SPEC, bool, O>;
...
pub type DC50_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLK_GPOUT0_CTRL_SPEC, bool, O>;
...
#[doc = "Field `PHASE` writer - This delays the enable signal by up to 3 cycles of the input clock  
 This must be set before the clock is enabled to have any effect"]
pub type PHASE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CLK_GPOUT0_CTRL_SPEC, u8, u8, 2, O>;
...
#[doc = "Field `NUDGE` writer - An edge on this signal shifts the phase of the output by 1 cycle of the input clock  
 This can be done at any time"]
pub type NUDGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLK_GPOUT0_CTRL_SPEC, bool, O>;
impl R {
