...
pub type AUXSRC_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_USB_CTRL_SPEC, 3, O, AUXSRC_A>;
...
pub type KILL_W<'a, const O: u8> = crate::BitWriter<'a, CLK_USB_CTRL_SPEC, O>;
...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, CLK_USB_CTRL_SPEC, O>;
...
#[doc = "Field `PHASE` writer - This delays the enable signal by up to 3 cycles of the input clock  
 This must be set before the clock is enabled to have any effect"]
pub type PHASE_W<'a, const O: u8> = crate::FieldWriter<'a, CLK_USB_CTRL_SPEC, 2, O>;
...
#[doc = "Field `NUDGE` writer - An edge on this signal shifts the phase of the output by 1 cycle of the input clock  
 This can be done at any time"]
pub type NUDGE_W<'a, const O: u8> = crate::BitWriter<'a, CLK_USB_CTRL_SPEC, O>;
impl R {
