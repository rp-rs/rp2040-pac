#[doc = "Reader of register CLK_GPOUT1_DIV"]
pub type R = crate::R<u32, super::CLK_GPOUT1_DIV>;
#[doc = "Writer for register CLK_GPOUT1_DIV"]
pub type W = crate::W<u32, super::CLK_GPOUT1_DIV>;
#[doc = "Register CLK_GPOUT1_DIV `reset()`'s with value 0x0100"]
impl crate::ResetValue for super::CLK_GPOUT1_DIV {
    type Type = u32;
    #[inline(always)]
