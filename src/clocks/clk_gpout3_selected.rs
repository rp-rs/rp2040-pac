...
pub struct R(crate::R<CLK_GPOUT3_SELECTED_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CLK_GPOUT3_SELECTED_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CLK_GPOUT3_SELECTED_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CLK_GPOUT3_SELECTED_SPEC>) -> Self {
        R(reader)
    }
}
...
For information about available fields see [clk_gpout3_selected](index.html) module"]
