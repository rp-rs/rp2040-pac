...
pub type FC0_SRC_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 8, O, FC0_SRC_A>;
impl<'a, REG, const O: u8> FC0_SRC_W<'a, REG, O>
where
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn fc0_src(&mut self) -> FC0_SRC_W<FC0_SRC_SPEC, 0> {
        FC0_SRC_W::new(self)
    }
