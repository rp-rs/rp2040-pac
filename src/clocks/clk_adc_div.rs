...
pub struct R(crate::R<CLK_ADC_DIV_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CLK_ADC_DIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CLK_ADC_DIV_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CLK_ADC_DIV_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CLK_ADC_DIV` writer"]
pub struct W(crate::W<CLK_ADC_DIV_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CLK_ADC_DIV_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CLK_ADC_DIV_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CLK_ADC_DIV_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type INT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CLK_ADC_DIV_SPEC, u8, u8, 2, O>;
impl R {
...
For information about available fields see [clk_adc_div](index.html) module"]
