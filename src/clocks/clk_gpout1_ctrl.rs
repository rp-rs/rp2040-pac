...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn auxsrc(&mut self) -> AUXSRC_W<CLK_GPOUT1_CTRL_SPEC, 5> {
        AUXSRC_W::new(self)
    }
    #[doc = "Bit 10 - Asynchronously kills the clock generator"]
    #[inline(always)]
    #[must_use]
    pub fn kill(&mut self) -> KILL_W<CLK_GPOUT1_CTRL_SPEC, 10> {
        KILL_W::new(self)
    }
    #[doc = "Bit 11 - Starts and stops the clock generator cleanly"]
    #[inline(always)]
    #[must_use]
    pub fn enable(&mut self) -> ENABLE_W<CLK_GPOUT1_CTRL_SPEC, 11> {
        ENABLE_W::new(self)
    }
    #[doc = "Bit 12 - Enables duty cycle correction for odd divisors"]
    #[inline(always)]
    #[must_use]
    pub fn dc50(&mut self) -> DC50_W<CLK_GPOUT1_CTRL_SPEC, 12> {
        DC50_W::new(self)
    }
    #[doc = "Bits 16:17 - This delays the enable signal by up to 3 cycles of the input clock  
 This must be set before the clock is enabled to have any effect"]
    #[inline(always)]
    #[must_use]
    pub fn phase(&mut self) -> PHASE_W<CLK_GPOUT1_CTRL_SPEC, 16> {
        PHASE_W::new(self)
    }
    #[doc = "Bit 20 - An edge on this signal shifts the phase of the output by 1 cycle of the input clock  
 This can be done at any time"]
    #[inline(always)]
    #[must_use]
    pub fn nudge(&mut self) -> NUDGE_W<CLK_GPOUT1_CTRL_SPEC, 20> {
        NUDGE_W::new(self)
    }
