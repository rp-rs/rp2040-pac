...
pub type SRC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, SRC_A>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn src(&mut self) -> SRC_W<CLK_SYS_CTRL_SPEC, 0> {
        SRC_W::new(self)
    }
    #[doc = "Bits 5:7 - Selects the auxiliary clock source, will glitch when switching"]
    #[inline(always)]
    #[must_use]
    pub fn auxsrc(&mut self) -> AUXSRC_W<CLK_SYS_CTRL_SPEC, 5> {
        AUXSRC_W::new(self)
    }
