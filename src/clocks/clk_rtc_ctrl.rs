...
pub struct R(crate::R<CLK_RTC_CTRL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CLK_RTC_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CLK_RTC_CTRL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CLK_RTC_CTRL_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CLK_RTC_CTRL` writer"]
pub struct W(crate::W<CLK_RTC_CTRL_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CLK_RTC_CTRL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CLK_RTC_CTRL_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CLK_RTC_CTRL_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type AUXSRC_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CLK_RTC_CTRL_SPEC, u8, AUXSRC_A, 3, O>;
...
pub type KILL_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLK_RTC_CTRL_SPEC, bool, O>;
...
pub type ENABLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLK_RTC_CTRL_SPEC, bool, O>;
...
#[doc = "Field `PHASE` writer - This delays the enable signal by up to 3 cycles of the input clock  
 This must be set before the clock is enabled to have any effect"]
pub type PHASE_W<'a, const O: u8> = crate::FieldWriter<'a, u32, CLK_RTC_CTRL_SPEC, u8, u8, 2, O>;
...
#[doc = "Field `NUDGE` writer - An edge on this signal shifts the phase of the output by 1 cycle of the input clock  
 This can be done at any time"]
pub type NUDGE_W<'a, const O: u8> = crate::BitWriter<'a, u32, CLK_RTC_CTRL_SPEC, bool, O>;
impl R {
...
For information about available fields see [clk_rtc_ctrl](index.html) module"]
