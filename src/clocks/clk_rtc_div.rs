#[doc = "Reader of register CLK_RTC_DIV"]
pub type R = crate::R<u32, super::CLK_RTC_DIV>;
#[doc = "Writer for register CLK_RTC_DIV"]
pub type W = crate::W<u32, super::CLK_RTC_DIV>;
#[doc = "Register CLK_RTC_DIV `reset()`'s with value 0x0100"]
impl crate::ResetValue for super::CLK_RTC_DIV {
    type Type = u32;
    #[inline(always)]
