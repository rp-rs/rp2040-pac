...
impl core::fmt::Debug for crate::generic::Reg<CLK_GPOUT0_SELECTED_SPEC> {
...
You can [`read`](crate::generic::Reg::read) this register and get [`clk_gpout0_selected::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
