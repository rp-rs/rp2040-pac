...
impl core::fmt::Debug for crate::generic::Reg<CLK_USB_SELECTED_SPEC> {
...
You can [`read`](crate::generic::Reg::read) this register and get [`clk_usb_selected::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
