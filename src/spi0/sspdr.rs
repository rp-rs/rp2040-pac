#[doc = "Reader of register SSPDR"]
pub type R = crate::R<u32, super::SSPDR>;
#[doc = "Writer for register SSPDR"]
pub type W = crate::W<u32, super::SSPDR>;
#[doc = "Register SSPDR `reset()`'s with value 0"]
impl crate::ResetValue for super::SSPDR {
    type Type = u32;
    #[inline(always)]
