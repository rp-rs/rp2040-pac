...
pub type SEC_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type MIN_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOUR_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DOTW_ENA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sec(&mut self) -> SEC_W<IRQ_SETUP_1_SPEC, 0> {
        SEC_W::new(self)
    }
    #[doc = "Bits 8:13 - Minutes"]
    #[inline(always)]
    #[must_use]
    pub fn min(&mut self) -> MIN_W<IRQ_SETUP_1_SPEC, 8> {
        MIN_W::new(self)
    }
    #[doc = "Bits 16:20 - Hours"]
    #[inline(always)]
    #[must_use]
    pub fn hour(&mut self) -> HOUR_W<IRQ_SETUP_1_SPEC, 16> {
        HOUR_W::new(self)
    }
    #[doc = "Bits 24:26 - Day of the week"]
    #[inline(always)]
    #[must_use]
    pub fn dotw(&mut self) -> DOTW_W<IRQ_SETUP_1_SPEC, 24> {
        DOTW_W::new(self)
    }
    #[doc = "Bit 28 - Enable second matching"]
    #[inline(always)]
    #[must_use]
    pub fn sec_ena(&mut self) -> SEC_ENA_W<IRQ_SETUP_1_SPEC, 28> {
        SEC_ENA_W::new(self)
    }
    #[doc = "Bit 29 - Enable minute matching"]
    #[inline(always)]
    #[must_use]
    pub fn min_ena(&mut self) -> MIN_ENA_W<IRQ_SETUP_1_SPEC, 29> {
        MIN_ENA_W::new(self)
    }
    #[doc = "Bit 30 - Enable hour matching"]
    #[inline(always)]
    #[must_use]
    pub fn hour_ena(&mut self) -> HOUR_ENA_W<IRQ_SETUP_1_SPEC, 30> {
        HOUR_ENA_W::new(self)
    }
    #[doc = "Bit 31 - Enable day of the week matching"]
    #[inline(always)]
    #[must_use]
    pub fn dotw_ena(&mut self) -> DOTW_ENA_W<IRQ_SETUP_1_SPEC, 31> {
        DOTW_ENA_W::new(self)
    }
