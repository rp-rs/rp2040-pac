#[doc = "Reader of register INSTR_MEM0"]
pub type R = crate::R<u32, super::INSTR_MEM0>;
#[doc = "Writer for register INSTR_MEM0"]
pub type W = crate::W<u32, super::INSTR_MEM0>;
#[doc = "Register INSTR_MEM0 `reset()`'s with value 0"]
impl crate::ResetValue for super::INSTR_MEM0 {
    type Type = u32;
    #[inline(always)]
