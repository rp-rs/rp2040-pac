#[doc = "Reader of register SM_INSTR"]
pub type R = crate::R<u32, super::SM_INSTR>;
#[doc = "Writer for register SM_INSTR"]
pub type W = crate::W<u32, super::SM_INSTR>;
#[doc = "Register SM_INSTR `reset()`'s with value 0"]
impl crate::ResetValue for super::SM_INSTR {
    type Type = u32;
    #[inline(always)]
