...
pub type STATUS_N_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 4, O>;
...
pub type STATUS_SEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O, STATUS_SEL_A>;
impl<'a, REG, const O: u8> STATUS_SEL_W<'a, REG, O>
where
...
pub type WRAP_BOTTOM_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
...
#[doc = "Field `WRAP_TOP` writer - After reaching this address, execution is wrapped to wrap_bottom.  
 If the instruction is a jump, and the jump condition is true, the jump takes priority."]
pub type WRAP_TOP_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
...
pub type OUT_STICKY_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
#[doc = "Field `INLINE_OUT_EN` writer - If 1, use a bit of OUT data as an auxiliary write enable  
 ...
 deassert the latest pin write. This can create useful masking/override behaviour  
 due to the priority ordering of state machine pin writes (SM0 &lt; SM1 &lt; ...)"]
pub type INLINE_OUT_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type OUT_EN_SEL_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
...
pub type JMP_PIN_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 5, O>;
...
pub type SIDE_PINDIR_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SIDE_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn status_n(&mut self) -> STATUS_N_W<SM_EXECCTRL_SPEC, 0> {
        STATUS_N_W::new(self)
    }
    #[doc = "Bit 4 - Comparison used for the MOV x, STATUS instruction."]
    #[inline(always)]
    #[must_use]
    pub fn status_sel(&mut self) -> STATUS_SEL_W<SM_EXECCTRL_SPEC, 4> {
        STATUS_SEL_W::new(self)
    }
    #[doc = "Bits 7:11 - After reaching wrap_top, execution is wrapped to this address."]
    #[inline(always)]
    #[must_use]
    pub fn wrap_bottom(&mut self) -> WRAP_BOTTOM_W<SM_EXECCTRL_SPEC, 7> {
 ...
 If the instruction is a jump, and the jump condition is true, the jump takes priority."]
    #[inline(always)]
    #[must_use]
    pub fn wrap_top(&mut self) -> WRAP_TOP_W<SM_EXECCTRL_SPEC, 12> {
        WRAP_TOP_W::new(self)
    }
    #[doc = "Bit 17 - Continuously assert the most recent OUT/SET to the pins"]
    #[inline(always)]
    #[must_use]
    pub fn out_sticky(&mut self) -> OUT_STICKY_W<SM_EXECCTRL_SPEC, 17> {
 ...
 due to the priority ordering of state machine pin writes (SM0 &lt; SM1 &lt; ...)"]
    #[inline(always)]
    #[must_use]
    pub fn inline_out_en(&mut self) -> INLINE_OUT_EN_W<SM_EXECCTRL_SPEC, 18> {
        INLINE_OUT_EN_W::new(self)
    }
    #[doc = "Bits 19:23 - Which data bit to use for inline OUT enable"]
    #[inline(always)]
    #[must_use]
    pub fn out_en_sel(&mut self) -> OUT_EN_SEL_W<SM_EXECCTRL_SPEC, 19> {
        OUT_EN_SEL_W::new(self)
    }
    #[doc = "Bits 24:28 - The GPIO number to use as condition for JMP PIN. Unaffected by input mapping."]
    #[inline(always)]
    #[must_use]
    pub fn jmp_pin(&mut self) -> JMP_PIN_W<SM_EXECCTRL_SPEC, 24> {
        JMP_PIN_W::new(self)
    }
    #[doc = "Bit 29 - If 1, side-set data is asserted to pin directions, instead of pin values"]
    #[inline(always)]
    #[must_use]
    pub fn side_pindir(&mut self) -> SIDE_PINDIR_W<SM_EXECCTRL_SPEC, 29> {
        SIDE_PINDIR_W::new(self)
    }
    #[doc = "Bit 30 - If 1, the MSB of the Delay/Side-set instruction field is used as side-set enable, rather than a side-set data bit. This allows instructions to perform side-set optionally, rather than on every instruction, but the maximum possible side-set width is reduced from 5 to 4. Note that the value of PINCTRL_SIDESET_COUNT is inclusive of this enable bit."]
    #[inline(always)]
    #[must_use]
    pub fn side_en(&mut self) -> SIDE_EN_W<SM_EXECCTRL_SPEC, 30> {
        SIDE_EN_W::new(self)
    }
