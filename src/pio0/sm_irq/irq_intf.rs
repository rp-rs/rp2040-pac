...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn sm0_rxnempty(&mut self) -> SM0_RXNEMPTY_W<IRQ_INTF_SPEC, 0> {
        SM0_RXNEMPTY_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn sm1_rxnempty(&mut self) -> SM1_RXNEMPTY_W<IRQ_INTF_SPEC, 1> {
        SM1_RXNEMPTY_W::new(self)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn sm2_rxnempty(&mut self) -> SM2_RXNEMPTY_W<IRQ_INTF_SPEC, 2> {
        SM2_RXNEMPTY_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn sm3_rxnempty(&mut self) -> SM3_RXNEMPTY_W<IRQ_INTF_SPEC, 3> {
        SM3_RXNEMPTY_W::new(self)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn sm0_txnfull(&mut self) -> SM0_TXNFULL_W<IRQ_INTF_SPEC, 4> {
        SM0_TXNFULL_W::new(self)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn sm1_txnfull(&mut self) -> SM1_TXNFULL_W<IRQ_INTF_SPEC, 5> {
        SM1_TXNFULL_W::new(self)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn sm2_txnfull(&mut self) -> SM2_TXNFULL_W<IRQ_INTF_SPEC, 6> {
        SM2_TXNFULL_W::new(self)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn sm3_txnfull(&mut self) -> SM3_TXNFULL_W<IRQ_INTF_SPEC, 7> {
        SM3_TXNFULL_W::new(self)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn sm0(&mut self) -> SM0_W<IRQ_INTF_SPEC, 8> {
        SM0_W::new(self)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn sm1(&mut self) -> SM1_W<IRQ_INTF_SPEC, 9> {
        SM1_W::new(self)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn sm2(&mut self) -> SM2_W<IRQ_INTF_SPEC, 10> {
        SM2_W::new(self)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn sm3(&mut self) -> SM3_W<IRQ_INTF_SPEC, 11> {
        SM3_W::new(self)
    }
