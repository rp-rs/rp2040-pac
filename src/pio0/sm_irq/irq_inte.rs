#[doc = "Reader of register IRQ_INTE"]
pub type R = crate::R<u32, super::IRQ_INTE>;
#[doc = "Writer for register IRQ_INTE"]
pub type W = crate::W<u32, super::IRQ_INTE>;
#[doc = "Register IRQ_INTE `reset()`'s with value 0"]
impl crate::ResetValue for super::IRQ_INTE {
    type Type = u32;
    #[inline(always)]
