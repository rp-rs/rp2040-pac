#[doc = "Reader of register GPIO_QSPI_SD2_CTRL"]
pub type R = crate::R<u32, super::GPIO_QSPI_SD2_CTRL>;
#[doc = "Writer for register GPIO_QSPI_SD2_CTRL"]
pub type W = crate::W<u32, super::GPIO_QSPI_SD2_CTRL>;
#[doc = "Register GPIO_QSPI_SD2_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO_QSPI_SD2_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(FUNCSEL_A::XIP_SD2),
            5 => Val(FUNCSEL_A::SIO_34),
            31 => Val(FUNCSEL_A::NULL),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `XIP_SD2`"]
    #[inline(always)]
    pub fn is_xip_sd2(&self) -> bool {
        *self == FUNCSEL_A::XIP_SD2
    }
    #[doc = "Checks if the value of the field is `SIO_34`"]
    #[inline(always)]
    pub fn is_sio_34(&self) -> bool {
        *self == FUNCSEL_A::SIO_34
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`0`"]
    #[inline(always)]
    pub fn xip_sd2(self) -> &'a mut W {
        self.variant(FUNCSEL_A::XIP_SD2)
    }
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_34(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_34)
    }
    #[doc = "`11111`"]
    #[inline(always)]
