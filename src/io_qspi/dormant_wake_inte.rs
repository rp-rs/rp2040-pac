...
impl W {
    ...
    pub fn gpio_qspi_sclk_level_low(
        &mut self,
    ) -> GPIO_QSPI_SCLK_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC, 0> {
    ...
    pub fn gpio_qspi_sclk_level_high(
        &mut self,
    ) -> GPIO_QSPI_SCLK_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC, 1> {
    ...
    pub fn gpio_qspi_sclk_edge_low(
        &mut self,
    ) -> GPIO_QSPI_SCLK_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC, 2> {
    ...
    pub fn gpio_qspi_sclk_edge_high(
        &mut self,
    ) -> GPIO_QSPI_SCLK_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC, 3> {
    ...
    pub fn gpio_qspi_ss_level_low(
        &mut self,
    ) -> GPIO_QSPI_SS_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC, 4> {
    ...
    pub fn gpio_qspi_ss_level_high(
        &mut self,
    ) -> GPIO_QSPI_SS_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC, 5> {
        GPIO_QSPI_SS_LEVEL_HIGH_W::new(self)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_qspi_ss_edge_low(&mut self) -> GPIO_QSPI_SS_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC, 6> {
    ...
    pub fn gpio_qspi_ss_edge_high(
        &mut self,
    ) -> GPIO_QSPI_SS_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC, 7> {
    ...
    pub fn gpio_qspi_sd0_level_low(
        &mut self,
    ) -> GPIO_QSPI_SD0_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC, 8> {
    ...
    pub fn gpio_qspi_sd0_level_high(
        &mut self,
    ) -> GPIO_QSPI_SD0_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC, 9> {
    ...
    pub fn gpio_qspi_sd0_edge_low(
        &mut self,
    ) -> GPIO_QSPI_SD0_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC, 10> {
    ...
    pub fn gpio_qspi_sd0_edge_high(
        &mut self,
    ) -> GPIO_QSPI_SD0_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC, 11> {
    ...
    pub fn gpio_qspi_sd1_level_low(
        &mut self,
    ) -> GPIO_QSPI_SD1_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC, 12> {
    ...
    pub fn gpio_qspi_sd1_level_high(
        &mut self,
    ) -> GPIO_QSPI_SD1_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC, 13> {
    ...
    pub fn gpio_qspi_sd1_edge_low(
        &mut self,
    ) -> GPIO_QSPI_SD1_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC, 14> {
    ...
    pub fn gpio_qspi_sd1_edge_high(
        &mut self,
    ) -> GPIO_QSPI_SD1_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC, 15> {
    ...
    pub fn gpio_qspi_sd2_level_low(
        &mut self,
    ) -> GPIO_QSPI_SD2_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC, 16> {
    ...
    pub fn gpio_qspi_sd2_level_high(
        &mut self,
    ) -> GPIO_QSPI_SD2_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC, 17> {
    ...
    pub fn gpio_qspi_sd2_edge_low(
        &mut self,
    ) -> GPIO_QSPI_SD2_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC, 18> {
    ...
    pub fn gpio_qspi_sd2_edge_high(
        &mut self,
    ) -> GPIO_QSPI_SD2_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC, 19> {
    ...
    pub fn gpio_qspi_sd3_level_low(
        &mut self,
    ) -> GPIO_QSPI_SD3_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC, 20> {
    ...
    pub fn gpio_qspi_sd3_level_high(
        &mut self,
    ) -> GPIO_QSPI_SD3_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC, 21> {
    ...
    pub fn gpio_qspi_sd3_edge_low(
        &mut self,
    ) -> GPIO_QSPI_SD3_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC, 22> {
    ...
    pub fn gpio_qspi_sd3_edge_high(
        &mut self,
    ) -> GPIO_QSPI_SD3_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC, 23> {
