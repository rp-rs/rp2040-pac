...
pub type GPIO_QSPI_SCLK_EDGE_LOW_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO_QSPI_SCLK_EDGE_HIGH_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO_QSPI_SS_EDGE_LOW_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO_QSPI_SS_EDGE_HIGH_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO_QSPI_SD0_EDGE_LOW_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO_QSPI_SD0_EDGE_HIGH_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO_QSPI_SD1_EDGE_LOW_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO_QSPI_SD1_EDGE_HIGH_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO_QSPI_SD2_EDGE_LOW_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO_QSPI_SD2_EDGE_HIGH_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO_QSPI_SD3_EDGE_LOW_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO_QSPI_SD3_EDGE_HIGH_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio_qspi_sclk_edge_low(&mut self) -> GPIO_QSPI_SCLK_EDGE_LOW_W<INTR_SPEC, 2> {
        GPIO_QSPI_SCLK_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_qspi_sclk_edge_high(&mut self) -> GPIO_QSPI_SCLK_EDGE_HIGH_W<INTR_SPEC, 3> {
        GPIO_QSPI_SCLK_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_qspi_ss_edge_low(&mut self) -> GPIO_QSPI_SS_EDGE_LOW_W<INTR_SPEC, 6> {
        GPIO_QSPI_SS_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_qspi_ss_edge_high(&mut self) -> GPIO_QSPI_SS_EDGE_HIGH_W<INTR_SPEC, 7> {
        GPIO_QSPI_SS_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_qspi_sd0_edge_low(&mut self) -> GPIO_QSPI_SD0_EDGE_LOW_W<INTR_SPEC, 10> {
        GPIO_QSPI_SD0_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_qspi_sd0_edge_high(&mut self) -> GPIO_QSPI_SD0_EDGE_HIGH_W<INTR_SPEC, 11> {
        GPIO_QSPI_SD0_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_qspi_sd1_edge_low(&mut self) -> GPIO_QSPI_SD1_EDGE_LOW_W<INTR_SPEC, 14> {
        GPIO_QSPI_SD1_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_qspi_sd1_edge_high(&mut self) -> GPIO_QSPI_SD1_EDGE_HIGH_W<INTR_SPEC, 15> {
        GPIO_QSPI_SD1_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_qspi_sd2_edge_low(&mut self) -> GPIO_QSPI_SD2_EDGE_LOW_W<INTR_SPEC, 18> {
        GPIO_QSPI_SD2_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_qspi_sd2_edge_high(&mut self) -> GPIO_QSPI_SD2_EDGE_HIGH_W<INTR_SPEC, 19> {
        GPIO_QSPI_SD2_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_qspi_sd3_edge_low(&mut self) -> GPIO_QSPI_SD3_EDGE_LOW_W<INTR_SPEC, 22> {
        GPIO_QSPI_SD3_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    #[must_use]
    pub fn gpio_qspi_sd3_edge_high(&mut self) -> GPIO_QSPI_SD3_EDGE_HIGH_W<INTR_SPEC, 23> {
