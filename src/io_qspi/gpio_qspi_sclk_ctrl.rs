#[doc = "Reader of register GPIO_QSPI_SCLK_CTRL"]
pub type R = crate::R<u32, super::GPIO_QSPI_SCLK_CTRL>;
#[doc = "Writer for register GPIO_QSPI_SCLK_CTRL"]
pub type W = crate::W<u32, super::GPIO_QSPI_SCLK_CTRL>;
#[doc = "Register GPIO_QSPI_SCLK_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO_QSPI_SCLK_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(FUNCSEL_A::XIP_SCLK),
            5 => Val(FUNCSEL_A::SIO_30),
