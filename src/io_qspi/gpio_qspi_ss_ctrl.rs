#[doc = "Reader of register GPIO_QSPI_SS_CTRL"]
pub type R = crate::R<u32, super::GPIO_QSPI_SS_CTRL>;
#[doc = "Writer for register GPIO_QSPI_SS_CTRL"]
pub type W = crate::W<u32, super::GPIO_QSPI_SS_CTRL>;
#[doc = "Register GPIO_QSPI_SS_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO_QSPI_SS_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(FUNCSEL_A::XIP_SS_N),
            5 => Val(FUNCSEL_A::SIO_31),
            31 => Val(FUNCSEL_A::NULL),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `XIP_SS_N`"]
    #[inline(always)]
    pub fn is_xip_ss_n(&self) -> bool {
        *self == FUNCSEL_A::XIP_SS_N
    }
    #[doc = "Checks if the value of the field is `SIO_31`"]
    #[inline(always)]
    pub fn is_sio_31(&self) -> bool {
        *self == FUNCSEL_A::SIO_31
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`0`"]
    #[inline(always)]
    pub fn xip_ss_n(self) -> &'a mut W {
        self.variant(FUNCSEL_A::XIP_SS_N)
    }
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_31(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_31)
    }
    #[doc = "`11111`"]
    #[inline(always)]
