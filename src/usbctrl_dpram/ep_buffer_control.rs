...
pub type LENGTH_0_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 10, O, u16>;
...
pub type AVAILABLE_0_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PID_0_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LAST_0_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FULL_0_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LENGTH_1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 10, O, u16>;
...
pub type AVAILABLE_1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
#[doc = "Field `DOUBLE_BUFFER_ISO_OFFSET` writer - The number of bytes buffer 1 is offset from buffer 0 in Isochronous mode. Only valid in double buffered mode for an Isochronous endpoint.  
 For a non Isochronous endpoint the offset is always 64 bytes."]
pub type DOUBLE_BUFFER_ISO_OFFSET_W<'a, REG, const O: u8> =
    crate::FieldWriterSafe<'a, REG, 2, O, DOUBLE_BUFFER_ISO_OFFSET_A>;
impl<'a, REG, const O: u8> DOUBLE_BUFFER_ISO_OFFSET_W<'a, REG, O>
where
...
pub type PID_1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type LAST_1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type FULL_1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn length_0(&mut self) -> LENGTH_0_W<EP_BUFFER_CONTROL_SPEC, 0> {
        LENGTH_0_W::new(self)
    }
    #[doc = "Bit 10 - Buffer 0 is available. This bit is set to indicate the buffer can be used by the controller. The controller clears the available bit when writing the status back."]
    #[inline(always)]
    #[must_use]
    pub fn available_0(&mut self) -> AVAILABLE_0_W<EP_BUFFER_CONTROL_SPEC, 10> {
        AVAILABLE_0_W::new(self)
    }
    #[doc = "Bit 11 - Reply with a stall (valid for both buffers)."]
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> STALL_W<EP_BUFFER_CONTROL_SPEC, 11> {
        STALL_W::new(self)
    }
    #[doc = "Bit 12 - Reset the buffer selector to buffer 0."]
    #[inline(always)]
    #[must_use]
    pub fn reset(&mut self) -> RESET_W<EP_BUFFER_CONTROL_SPEC, 12> {
        RESET_W::new(self)
    }
    #[doc = "Bit 13 - The data pid of buffer 0."]
    #[inline(always)]
    #[must_use]
    pub fn pid_0(&mut self) -> PID_0_W<EP_BUFFER_CONTROL_SPEC, 13> {
        PID_0_W::new(self)
    }
    #[doc = "Bit 14 - Buffer 0 is the last buffer of the transfer."]
    #[inline(always)]
    #[must_use]
    pub fn last_0(&mut self) -> LAST_0_W<EP_BUFFER_CONTROL_SPEC, 14> {
        LAST_0_W::new(self)
    }
    #[doc = "Bit 15 - Buffer 0 is full. For an IN transfer (TX to the host) the bit is set to indicate the data is valid. For an OUT transfer (RX from the host) this bit should be left as a 0. The host will set it when it has filled the buffer with data."]
    #[inline(always)]
    #[must_use]
    pub fn full_0(&mut self) -> FULL_0_W<EP_BUFFER_CONTROL_SPEC, 15> {
        FULL_0_W::new(self)
    }
    #[doc = "Bits 16:25 - The length of the data in buffer 1."]
    #[inline(always)]
    #[must_use]
    pub fn length_1(&mut self) -> LENGTH_1_W<EP_BUFFER_CONTROL_SPEC, 16> {
        LENGTH_1_W::new(self)
    }
    #[doc = "Bit 26 - Buffer 1 is available. This bit is set to indicate the buffer can be used by the controller. The controller clears the available bit when writing the status back."]
    #[inline(always)]
    #[must_use]
    pub fn available_1(&mut self) -> AVAILABLE_1_W<EP_BUFFER_CONTROL_SPEC, 26> {
 ...
 For a non Isochronous endpoint the offset is always 64 bytes."]
    ...
    pub fn double_buffer_iso_offset(
        &mut self,
    ) -> DOUBLE_BUFFER_ISO_OFFSET_W<EP_BUFFER_CONTROL_SPEC, 27> {
        DOUBLE_BUFFER_ISO_OFFSET_W::new(self)
    }
    #[doc = "Bit 29 - The data pid of buffer 1."]
    #[inline(always)]
    #[must_use]
    pub fn pid_1(&mut self) -> PID_1_W<EP_BUFFER_CONTROL_SPEC, 29> {
        PID_1_W::new(self)
    }
    #[doc = "Bit 30 - Buffer 1 is the last buffer of the transfer."]
    #[inline(always)]
    #[must_use]
    pub fn last_1(&mut self) -> LAST_1_W<EP_BUFFER_CONTROL_SPEC, 30> {
        LAST_1_W::new(self)
    }
    #[doc = "Bit 31 - Buffer 1 is full. For an IN transfer (TX to the host) the bit is set to indicate the data is valid. For an OUT transfer (RX from the host) this bit should be left as a 0. The host will set it when it has filled the buffer with data."]
    #[inline(always)]
    #[must_use]
    pub fn full_1(&mut self) -> FULL_1_W<EP_BUFFER_CONTROL_SPEC, 31> {
        FULL_1_W::new(self)
    }
