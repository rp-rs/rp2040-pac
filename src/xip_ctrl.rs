...
#[doc = "Cache control"]
pub mod ctrl;
#[doc = "FLUSH (rw) register accessor: an alias for `Reg<FLUSH_SPEC>`"]
...
#[doc = "Cache Status"]
pub mod stat;
#[doc = "CTR_HIT (rw) register accessor: an alias for `Reg<CTR_HIT_SPEC>`"]
...
#[doc = "Cache Hit counter  
 ...
 Write any value to clear."]
pub mod ctr_hit;
#[doc = "CTR_ACC (rw) register accessor: an alias for `Reg<CTR_ACC_SPEC>`"]
...
#[doc = "Cache Access counter  
 ...
 Write any value to clear."]
pub mod ctr_acc;
#[doc = "STREAM_ADDR (rw) register accessor: an alias for `Reg<STREAM_ADDR_SPEC>`"]
pub type STREAM_ADDR = crate::Reg<stream_addr::STREAM_ADDR_SPEC>;
#[doc = "FIFO stream address"]
pub mod stream_addr;
#[doc = "STREAM_CTR (rw) register accessor: an alias for `Reg<STREAM_CTR_SPEC>`"]
pub type STREAM_CTR = crate::Reg<stream_ctr::STREAM_CTR_SPEC>;
#[doc = "FIFO stream control"]
pub mod stream_ctr;
#[doc = "STREAM_FIFO (r) register accessor: an alias for `Reg<STREAM_FIFO_SPEC>`"]
