...
#[doc = "BUS_PRIORITY (rw) register accessor: an alias for `Reg<BUS_PRIORITY_SPEC>`"]
...
#[doc = "BUS_PRIORITY_ACK (r) register accessor: an alias for `Reg<BUS_PRIORITY_ACK_SPEC>`"]
