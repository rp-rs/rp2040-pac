#[doc = "Reader of register GPIO27_CTRL"]
pub type R = crate::R<u32, super::GPIO27_CTRL>;
#[doc = "Writer for register GPIO27_CTRL"]
pub type W = crate::W<u32, super::GPIO27_CTRL>;
#[doc = "Register GPIO27_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO27_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        ...
        match self.bits {
            ...
            5 => Val(FUNCSEL_A::SIO_27),
            6 => Val(FUNCSEL_A::PIO0_27),
            7 => Val(FUNCSEL_A::PIO1_27),
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_27(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_27)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_27(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_27)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_27(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_27)
    }
    #[doc = "`1001`"]
    #[inline(always)]
