#[doc = "Reader of register GPIO24_CTRL"]
pub type R = crate::R<u32, super::GPIO24_CTRL>;
#[doc = "Writer for register GPIO24_CTRL"]
pub type W = crate::W<u32, super::GPIO24_CTRL>;
#[doc = "Register GPIO24_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO24_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        ...
        match self.bits {
            ...
            5 => Val(FUNCSEL_A::SIO_24),
            6 => Val(FUNCSEL_A::PIO0_24),
            7 => Val(FUNCSEL_A::PIO1_24),
            8 => Val(FUNCSEL_A::CLOCKS_GPOUT_2),
    ...
    #[doc = "Checks if the value of the field is `SIO_24`"]
    #[inline(always)]
    pub fn is_sio_24(&self) -> bool {
        *self == FUNCSEL_A::SIO_24
    }
    #[doc = "Checks if the value of the field is `PIO0_24`"]
    #[inline(always)]
    pub fn is_pio0_24(&self) -> bool {
        *self == FUNCSEL_A::PIO0_24
    }
    #[doc = "Checks if the value of the field is `PIO1_24`"]
    #[inline(always)]
    pub fn is_pio1_24(&self) -> bool {
        *self == FUNCSEL_A::PIO1_24
    }
    #[doc = "Checks if the value of the field is `CLOCKS_GPOUT_2`"]
    #[inline(always)]
    pub fn is_clocks_gpout_2(&self) -> bool {
        *self == FUNCSEL_A::CLOCKS_GPOUT_2
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_24(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_24)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_24(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_24)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_24(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_24)
    }
    #[doc = "`1000`"]
    #[inline(always)]
    pub fn clocks_gpout_2(self) -> &'a mut W {
        self.variant(FUNCSEL_A::CLOCKS_GPOUT_2)
    }
    #[doc = "`1001`"]
    #[inline(always)]
