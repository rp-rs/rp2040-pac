#[doc = "Reader of register GPIO4_CTRL"]
pub type R = crate::R<u32, super::GPIO4_CTRL>;
#[doc = "Writer for register GPIO4_CTRL"]
pub type W = crate::W<u32, super::GPIO4_CTRL>;
#[doc = "Register GPIO4_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO4_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        ...
        match self.bits {
            ...
            5 => Val(FUNCSEL_A::SIO_4),
            6 => Val(FUNCSEL_A::PIO0_4),
            7 => Val(FUNCSEL_A::PIO1_4),
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_4(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_4)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_4(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_4)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_4(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_4)
    }
    #[doc = "`1001`"]
    #[inline(always)]
