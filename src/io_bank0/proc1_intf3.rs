#[doc = "Register `PROC1_INTF3` reader"]
pub struct R(crate::R<PROC1_INTF3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PROC1_INTF3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PROC1_INTF3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PROC1_INTF3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `PROC1_INTF3` writer"]
pub struct W(crate::W<PROC1_INTF3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<PROC1_INTF3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<PROC1_INTF3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<PROC1_INTF3_SPEC>) -> Self {
        W(writer)
    }
}
...
For information about available fields see [proc1_intf3](index.html) module"]
pub struct PROC1_INTF3_SPEC;
impl crate::RegisterSpec for PROC1_INTF3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [proc1_intf3::R](R) reader structure"]
impl crate::Readable for PROC1_INTF3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [proc1_intf3::W](W) writer structure"]
impl crate::Writable for PROC1_INTF3_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets PROC1_INTF3 to value 0"]
impl crate::Resettable for PROC1_INTF3_SPEC {
    #[inline(always)]
