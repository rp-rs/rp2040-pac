#[doc = "Reader of register GPIO0_CTRL"]
pub type R = crate::R<u32, super::GPIO0_CTRL>;
#[doc = "Writer for register GPIO0_CTRL"]
pub type W = crate::W<u32, super::GPIO0_CTRL>;
#[doc = "Register GPIO0_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO0_CTRL {
    type Type = u32;
    #[inline(always)]
