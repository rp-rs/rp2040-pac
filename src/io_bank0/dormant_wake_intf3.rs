#[doc = "Register `DORMANT_WAKE_INTF3` reader"]
pub struct R(crate::R<DORMANT_WAKE_INTF3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DORMANT_WAKE_INTF3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DORMANT_WAKE_INTF3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DORMANT_WAKE_INTF3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `DORMANT_WAKE_INTF3` writer"]
pub struct W(crate::W<DORMANT_WAKE_INTF3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<DORMANT_WAKE_INTF3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<DORMANT_WAKE_INTF3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<DORMANT_WAKE_INTF3_SPEC>) -> Self {
        W(writer)
    }
}
...
For information about available fields see [dormant_wake_intf3](index.html) module"]
pub struct DORMANT_WAKE_INTF3_SPEC;
impl crate::RegisterSpec for DORMANT_WAKE_INTF3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dormant_wake_intf3::R](R) reader structure"]
impl crate::Readable for DORMANT_WAKE_INTF3_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [dormant_wake_intf3::W](W) writer structure"]
impl crate::Writable for DORMANT_WAKE_INTF3_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets DORMANT_WAKE_INTF3 to value 0"]
impl crate::Resettable for DORMANT_WAKE_INTF3_SPEC {
    #[inline(always)]
