#[doc = "Reader of register GPIO16_CTRL"]
pub type R = crate::R<u32, super::GPIO16_CTRL>;
#[doc = "Writer for register GPIO16_CTRL"]
pub type W = crate::W<u32, super::GPIO16_CTRL>;
#[doc = "Register GPIO16_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO16_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        ...
        match self.bits {
            ...
            5 => Val(FUNCSEL_A::SIO_16),
            6 => Val(FUNCSEL_A::PIO0_16),
            7 => Val(FUNCSEL_A::PIO1_16),
            8 => Val(FUNCSEL_A::USB_MUXING_DIGITAL_DM),
    ...
    #[doc = "Checks if the value of the field is `SIO_16`"]
    #[inline(always)]
    pub fn is_sio_16(&self) -> bool {
        *self == FUNCSEL_A::SIO_16
    }
    #[doc = "Checks if the value of the field is `PIO0_16`"]
    #[inline(always)]
    pub fn is_pio0_16(&self) -> bool {
        *self == FUNCSEL_A::PIO0_16
    }
    #[doc = "Checks if the value of the field is `PIO1_16`"]
    #[inline(always)]
    pub fn is_pio1_16(&self) -> bool {
        *self == FUNCSEL_A::PIO1_16
    }
    #[doc = "Checks if the value of the field is `USB_MUXING_DIGITAL_DM`"]
    #[inline(always)]
    pub fn is_usb_muxing_digital_dm(&self) -> bool {
        *self == FUNCSEL_A::USB_MUXING_DIGITAL_DM
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_16(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_16)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_16(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_16)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_16(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_16)
    }
    #[doc = "`1000`"]
    #[inline(always)]
    pub fn usb_muxing_digital_dm(self) -> &'a mut W {
        self.variant(FUNCSEL_A::USB_MUXING_DIGITAL_DM)
    }
    #[doc = "`1001`"]
    #[inline(always)]
