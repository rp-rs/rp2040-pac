#[doc = "Reader of register GPIO21_CTRL"]
pub type R = crate::R<u32, super::GPIO21_CTRL>;
#[doc = "Writer for register GPIO21_CTRL"]
pub type W = crate::W<u32, super::GPIO21_CTRL>;
#[doc = "Register GPIO21_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO21_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        ...
        match self.bits {
            ...
            5 => Val(FUNCSEL_A::SIO_21),
            6 => Val(FUNCSEL_A::PIO0_21),
            7 => Val(FUNCSEL_A::PIO1_21),
            8 => Val(FUNCSEL_A::CLOCKS_GPOUT_0),
    ...
    #[doc = "Checks if the value of the field is `SIO_21`"]
    #[inline(always)]
    pub fn is_sio_21(&self) -> bool {
        *self == FUNCSEL_A::SIO_21
    }
    #[doc = "Checks if the value of the field is `PIO0_21`"]
    #[inline(always)]
    pub fn is_pio0_21(&self) -> bool {
        *self == FUNCSEL_A::PIO0_21
    }
    #[doc = "Checks if the value of the field is `PIO1_21`"]
    #[inline(always)]
    pub fn is_pio1_21(&self) -> bool {
        *self == FUNCSEL_A::PIO1_21
    }
    #[doc = "Checks if the value of the field is `CLOCKS_GPOUT_0`"]
    #[inline(always)]
    pub fn is_clocks_gpout_0(&self) -> bool {
        *self == FUNCSEL_A::CLOCKS_GPOUT_0
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_21(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_21)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_21(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_21)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_21(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_21)
    }
    #[doc = "`1000`"]
    #[inline(always)]
    pub fn clocks_gpout_0(self) -> &'a mut W {
        self.variant(FUNCSEL_A::CLOCKS_GPOUT_0)
    }
    #[doc = "`1001`"]
    #[inline(always)]
