#[doc = "Reader of register GPIO13_CTRL"]
pub type R = crate::R<u32, super::GPIO13_CTRL>;
#[doc = "Writer for register GPIO13_CTRL"]
pub type W = crate::W<u32, super::GPIO13_CTRL>;
#[doc = "Register GPIO13_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO13_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        ...
        match self.bits {
            ...
            5 => Val(FUNCSEL_A::SIO_13),
            6 => Val(FUNCSEL_A::PIO0_13),
            7 => Val(FUNCSEL_A::PIO1_13),
            8 => Val(FUNCSEL_A::USB_MUXING_EXTPHY_VPO),
    ...
    #[doc = "Checks if the value of the field is `SIO_13`"]
    #[inline(always)]
    pub fn is_sio_13(&self) -> bool {
        *self == FUNCSEL_A::SIO_13
    }
    #[doc = "Checks if the value of the field is `PIO0_13`"]
    #[inline(always)]
    pub fn is_pio0_13(&self) -> bool {
        *self == FUNCSEL_A::PIO0_13
    }
    #[doc = "Checks if the value of the field is `PIO1_13`"]
    #[inline(always)]
    pub fn is_pio1_13(&self) -> bool {
        *self == FUNCSEL_A::PIO1_13
    }
    #[doc = "Checks if the value of the field is `USB_MUXING_EXTPHY_VPO`"]
    #[inline(always)]
    pub fn is_usb_muxing_extphy_vpo(&self) -> bool {
        *self == FUNCSEL_A::USB_MUXING_EXTPHY_VPO
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_13(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_13)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_13(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_13)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_13(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_13)
    }
    #[doc = "`1000`"]
    #[inline(always)]
    pub fn usb_muxing_extphy_vpo(self) -> &'a mut W {
        self.variant(FUNCSEL_A::USB_MUXING_EXTPHY_VPO)
    }
    #[doc = "`1001`"]
    #[inline(always)]
