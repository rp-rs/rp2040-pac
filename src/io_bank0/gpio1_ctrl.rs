#[doc = "Reader of register GPIO1_CTRL"]
pub type R = crate::R<u32, super::GPIO1_CTRL>;
#[doc = "Writer for register GPIO1_CTRL"]
pub type W = crate::W<u32, super::GPIO1_CTRL>;
#[doc = "Register GPIO1_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO1_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(FUNCSEL_A::JTAG_TMS),
            1 => Val(FUNCSEL_A::SPI0_SS_N),
            2 => Val(FUNCSEL_A::UART0_RX),
            3 => Val(FUNCSEL_A::I2C0_SCL),
            4 => Val(FUNCSEL_A::PWM_B_0),
            5 => Val(FUNCSEL_A::SIO_1),
            6 => Val(FUNCSEL_A::PIO0_1),
            7 => Val(FUNCSEL_A::PIO1_1),
            9 => Val(FUNCSEL_A::USB_MUXING_VBUS_DETECT),
            31 => Val(FUNCSEL_A::NULL),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `JTAG_TMS`"]
    #[inline(always)]
    pub fn is_jtag_tms(&self) -> bool {
        *self == FUNCSEL_A::JTAG_TMS
    }
    ...
    #[doc = "Checks if the value of the field is `PWM_B_0`"]
    #[inline(always)]
    pub fn is_pwm_b_0(&self) -> bool {
        *self == FUNCSEL_A::PWM_B_0
    }
    #[doc = "Checks if the value of the field is `SIO_1`"]
    #[inline(always)]
    pub fn is_sio_1(&self) -> bool {
        *self == FUNCSEL_A::SIO_1
    }
    #[doc = "Checks if the value of the field is `PIO0_1`"]
    #[inline(always)]
    pub fn is_pio0_1(&self) -> bool {
        *self == FUNCSEL_A::PIO0_1
    }
    #[doc = "Checks if the value of the field is `PIO1_1`"]
    #[inline(always)]
    pub fn is_pio1_1(&self) -> bool {
        *self == FUNCSEL_A::PIO1_1
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`0`"]
    #[inline(always)]
    pub fn jtag_tms(self) -> &'a mut W {
        self.variant(FUNCSEL_A::JTAG_TMS)
    }
    #[doc = "`1`"]
    #[inline(always)]
    ...
    #[doc = "`100`"]
    #[inline(always)]
    pub fn pwm_b_0(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PWM_B_0)
    }
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_1(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_1)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_1(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_1)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_1(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_1)
    }
    #[doc = "`1001`"]
    #[inline(always)]
