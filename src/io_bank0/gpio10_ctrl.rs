#[doc = "Reader of register GPIO10_CTRL"]
pub type R = crate::R<u32, super::GPIO10_CTRL>;
#[doc = "Writer for register GPIO10_CTRL"]
pub type W = crate::W<u32, super::GPIO10_CTRL>;
#[doc = "Register GPIO10_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO10_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        ...
        match self.bits {
            ...
            4 => Val(FUNCSEL_A::PWM_A_5),
            5 => Val(FUNCSEL_A::SIO_10),
            6 => Val(FUNCSEL_A::PIO0_10),
            7 => Val(FUNCSEL_A::PIO1_10),
            8 => Val(FUNCSEL_A::USB_MUXING_EXTPHY_VM),
    ...
    #[doc = "Checks if the value of the field is `PWM_A_5`"]
    #[inline(always)]
    pub fn is_pwm_a_5(&self) -> bool {
        *self == FUNCSEL_A::PWM_A_5
    }
    #[doc = "Checks if the value of the field is `SIO_10`"]
    #[inline(always)]
    pub fn is_sio_10(&self) -> bool {
        *self == FUNCSEL_A::SIO_10
    }
    #[doc = "Checks if the value of the field is `PIO0_10`"]
    #[inline(always)]
    pub fn is_pio0_10(&self) -> bool {
        *self == FUNCSEL_A::PIO0_10
    }
    #[doc = "Checks if the value of the field is `PIO1_10`"]
    #[inline(always)]
    pub fn is_pio1_10(&self) -> bool {
        *self == FUNCSEL_A::PIO1_10
    }
    #[doc = "Checks if the value of the field is `USB_MUXING_EXTPHY_VM`"]
    #[inline(always)]
    pub fn is_usb_muxing_extphy_vm(&self) -> bool {
        *self == FUNCSEL_A::USB_MUXING_EXTPHY_VM
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`100`"]
    #[inline(always)]
    pub fn pwm_a_5(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PWM_A_5)
    }
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_10(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_10)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_10(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_10)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_10(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_10)
    }
    #[doc = "`1000`"]
    #[inline(always)]
    pub fn usb_muxing_extphy_vm(self) -> &'a mut W {
        self.variant(FUNCSEL_A::USB_MUXING_EXTPHY_VM)
    }
    #[doc = "`1001`"]
    #[inline(always)]
