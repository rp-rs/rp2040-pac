#[doc = "Reader of register GPIO23_CTRL"]
pub type R = crate::R<u32, super::GPIO23_CTRL>;
#[doc = "Writer for register GPIO23_CTRL"]
pub type W = crate::W<u32, super::GPIO23_CTRL>;
#[doc = "Register GPIO23_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO23_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        ...
        match self.bits {
            ...
            5 => Val(FUNCSEL_A::SIO_23),
            6 => Val(FUNCSEL_A::PIO0_23),
            7 => Val(FUNCSEL_A::PIO1_23),
            8 => Val(FUNCSEL_A::CLOCKS_GPOUT_1),
    ...
    #[doc = "Checks if the value of the field is `SIO_23`"]
    #[inline(always)]
    pub fn is_sio_23(&self) -> bool {
        *self == FUNCSEL_A::SIO_23
    }
    #[doc = "Checks if the value of the field is `PIO0_23`"]
    #[inline(always)]
    pub fn is_pio0_23(&self) -> bool {
        *self == FUNCSEL_A::PIO0_23
    }
    #[doc = "Checks if the value of the field is `PIO1_23`"]
    #[inline(always)]
    pub fn is_pio1_23(&self) -> bool {
        *self == FUNCSEL_A::PIO1_23
    }
    #[doc = "Checks if the value of the field is `CLOCKS_GPOUT_1`"]
    #[inline(always)]
    pub fn is_clocks_gpout_1(&self) -> bool {
        *self == FUNCSEL_A::CLOCKS_GPOUT_1
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_23(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_23)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_23(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_23)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_23(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_23)
    }
    #[doc = "`1000`"]
    #[inline(always)]
    pub fn clocks_gpout_1(self) -> &'a mut W {
        self.variant(FUNCSEL_A::CLOCKS_GPOUT_1)
    }
    #[doc = "`1001`"]
    #[inline(always)]
