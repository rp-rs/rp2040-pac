#[doc = "Reader of register GPIO3_CTRL"]
pub type R = crate::R<u32, super::GPIO3_CTRL>;
#[doc = "Writer for register GPIO3_CTRL"]
pub type W = crate::W<u32, super::GPIO3_CTRL>;
#[doc = "Register GPIO3_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO3_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(FUNCSEL_A::JTAG_TDO),
            1 => Val(FUNCSEL_A::SPI0_TX),
            2 => Val(FUNCSEL_A::UART0_RTS),
            3 => Val(FUNCSEL_A::I2C1_SCL),
            4 => Val(FUNCSEL_A::PWM_B_1),
            5 => Val(FUNCSEL_A::SIO_3),
            6 => Val(FUNCSEL_A::PIO0_3),
            7 => Val(FUNCSEL_A::PIO1_3),
            9 => Val(FUNCSEL_A::USB_MUXING_OVERCURR_DETECT),
            31 => Val(FUNCSEL_A::NULL),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `JTAG_TDO`"]
    #[inline(always)]
    pub fn is_jtag_tdo(&self) -> bool {
        *self == FUNCSEL_A::JTAG_TDO
    }
    ...
    #[doc = "Checks if the value of the field is `PWM_B_1`"]
    #[inline(always)]
    pub fn is_pwm_b_1(&self) -> bool {
        *self == FUNCSEL_A::PWM_B_1
    }
    #[doc = "Checks if the value of the field is `SIO_3`"]
    #[inline(always)]
    pub fn is_sio_3(&self) -> bool {
        *self == FUNCSEL_A::SIO_3
    }
    #[doc = "Checks if the value of the field is `PIO0_3`"]
    #[inline(always)]
    pub fn is_pio0_3(&self) -> bool {
        *self == FUNCSEL_A::PIO0_3
    }
    #[doc = "Checks if the value of the field is `PIO1_3`"]
    #[inline(always)]
    pub fn is_pio1_3(&self) -> bool {
        *self == FUNCSEL_A::PIO1_3
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`0`"]
    #[inline(always)]
    pub fn jtag_tdo(self) -> &'a mut W {
        self.variant(FUNCSEL_A::JTAG_TDO)
    }
    #[doc = "`1`"]
    #[inline(always)]
    ...
    #[doc = "`100`"]
    #[inline(always)]
    pub fn pwm_b_1(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PWM_B_1)
    }
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_3(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_3)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_3(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_3)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_3(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_3)
    }
    #[doc = "`1001`"]
    #[inline(always)]
