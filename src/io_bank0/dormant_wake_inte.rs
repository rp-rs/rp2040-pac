...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio0_level_low(&mut self) -> GPIO0_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC, 0> {
        GPIO0_LEVEL_LOW_W::new(self)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0_level_high(&mut self) -> GPIO0_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC, 1> {
        GPIO0_LEVEL_HIGH_W::new(self)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0_edge_low(&mut self) -> GPIO0_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC, 2> {
        GPIO0_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0_edge_high(&mut self) -> GPIO0_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC, 3> {
        GPIO0_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 4"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1_level_low(&mut self) -> GPIO1_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC, 4> {
        GPIO1_LEVEL_LOW_W::new(self)
    }
    #[doc = "Bit 5"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1_level_high(&mut self) -> GPIO1_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC, 5> {
        GPIO1_LEVEL_HIGH_W::new(self)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1_edge_low(&mut self) -> GPIO1_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC, 6> {
        GPIO1_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1_edge_high(&mut self) -> GPIO1_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC, 7> {
        GPIO1_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 8"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2_level_low(&mut self) -> GPIO2_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC, 8> {
        GPIO2_LEVEL_LOW_W::new(self)
    }
    #[doc = "Bit 9"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2_level_high(&mut self) -> GPIO2_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC, 9> {
        GPIO2_LEVEL_HIGH_W::new(self)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2_edge_low(&mut self) -> GPIO2_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC, 10> {
        GPIO2_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2_edge_high(&mut self) -> GPIO2_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC, 11> {
        GPIO2_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 12"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3_level_low(&mut self) -> GPIO3_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC, 12> {
        GPIO3_LEVEL_LOW_W::new(self)
    }
    #[doc = "Bit 13"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3_level_high(&mut self) -> GPIO3_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC, 13> {
        GPIO3_LEVEL_HIGH_W::new(self)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3_edge_low(&mut self) -> GPIO3_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC, 14> {
        GPIO3_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3_edge_high(&mut self) -> GPIO3_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC, 15> {
        GPIO3_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 16"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4_level_low(&mut self) -> GPIO4_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC, 16> {
        GPIO4_LEVEL_LOW_W::new(self)
    }
    #[doc = "Bit 17"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4_level_high(&mut self) -> GPIO4_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC, 17> {
        GPIO4_LEVEL_HIGH_W::new(self)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4_edge_low(&mut self) -> GPIO4_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC, 18> {
        GPIO4_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4_edge_high(&mut self) -> GPIO4_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC, 19> {
        GPIO4_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 20"]
    #[inline(always)]
    #[must_use]
    pub fn gpio5_level_low(&mut self) -> GPIO5_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC, 20> {
        GPIO5_LEVEL_LOW_W::new(self)
    }
    #[doc = "Bit 21"]
    #[inline(always)]
    #[must_use]
    pub fn gpio5_level_high(&mut self) -> GPIO5_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC, 21> {
        GPIO5_LEVEL_HIGH_W::new(self)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    #[must_use]
    pub fn gpio5_edge_low(&mut self) -> GPIO5_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC, 22> {
        GPIO5_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    #[must_use]
    pub fn gpio5_edge_high(&mut self) -> GPIO5_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC, 23> {
        GPIO5_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 24"]
    #[inline(always)]
    #[must_use]
    pub fn gpio6_level_low(&mut self) -> GPIO6_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC, 24> {
        GPIO6_LEVEL_LOW_W::new(self)
    }
    #[doc = "Bit 25"]
    #[inline(always)]
    #[must_use]
    pub fn gpio6_level_high(&mut self) -> GPIO6_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC, 25> {
        GPIO6_LEVEL_HIGH_W::new(self)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    #[must_use]
    pub fn gpio6_edge_low(&mut self) -> GPIO6_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC, 26> {
        GPIO6_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    #[must_use]
    pub fn gpio6_edge_high(&mut self) -> GPIO6_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC, 27> {
        GPIO6_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 28"]
    #[inline(always)]
    #[must_use]
    pub fn gpio7_level_low(&mut self) -> GPIO7_LEVEL_LOW_W<DORMANT_WAKE_INTE_SPEC, 28> {
        GPIO7_LEVEL_LOW_W::new(self)
    }
    #[doc = "Bit 29"]
    #[inline(always)]
    #[must_use]
    pub fn gpio7_level_high(&mut self) -> GPIO7_LEVEL_HIGH_W<DORMANT_WAKE_INTE_SPEC, 29> {
        GPIO7_LEVEL_HIGH_W::new(self)
    }
    #[doc = "Bit 30"]
    #[inline(always)]
    #[must_use]
    pub fn gpio7_edge_low(&mut self) -> GPIO7_EDGE_LOW_W<DORMANT_WAKE_INTE_SPEC, 30> {
        GPIO7_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn gpio7_edge_high(&mut self) -> GPIO7_EDGE_HIGH_W<DORMANT_WAKE_INTE_SPEC, 31> {
