#[doc = "Reader of register GPIO2_CTRL"]
pub type R = crate::R<u32, super::GPIO2_CTRL>;
#[doc = "Writer for register GPIO2_CTRL"]
pub type W = crate::W<u32, super::GPIO2_CTRL>;
#[doc = "Register GPIO2_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO2_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        use crate::Variant::*;
        match self.bits {
            0 => Val(FUNCSEL_A::JTAG_TDI),
            1 => Val(FUNCSEL_A::SPI0_SCLK),
            2 => Val(FUNCSEL_A::UART0_CTS),
            3 => Val(FUNCSEL_A::I2C1_SDA),
            4 => Val(FUNCSEL_A::PWM_A_1),
            5 => Val(FUNCSEL_A::SIO_2),
            6 => Val(FUNCSEL_A::PIO0_2),
            7 => Val(FUNCSEL_A::PIO1_2),
            9 => Val(FUNCSEL_A::USB_MUXING_VBUS_EN),
            31 => Val(FUNCSEL_A::NULL),
            i => Res(i),
        }
    }
    #[doc = "Checks if the value of the field is `JTAG_TDI`"]
    #[inline(always)]
    pub fn is_jtag_tdi(&self) -> bool {
        *self == FUNCSEL_A::JTAG_TDI
    }
    ...
    #[doc = "Checks if the value of the field is `PWM_A_1`"]
    #[inline(always)]
    pub fn is_pwm_a_1(&self) -> bool {
        *self == FUNCSEL_A::PWM_A_1
    }
    #[doc = "Checks if the value of the field is `SIO_2`"]
    #[inline(always)]
    pub fn is_sio_2(&self) -> bool {
        *self == FUNCSEL_A::SIO_2
    }
    #[doc = "Checks if the value of the field is `PIO0_2`"]
    #[inline(always)]
    pub fn is_pio0_2(&self) -> bool {
        *self == FUNCSEL_A::PIO0_2
    }
    #[doc = "Checks if the value of the field is `PIO1_2`"]
    #[inline(always)]
    pub fn is_pio1_2(&self) -> bool {
        *self == FUNCSEL_A::PIO1_2
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`0`"]
    #[inline(always)]
    pub fn jtag_tdi(self) -> &'a mut W {
        self.variant(FUNCSEL_A::JTAG_TDI)
    }
    #[doc = "`1`"]
    #[inline(always)]
    ...
    #[doc = "`100`"]
    #[inline(always)]
    pub fn pwm_a_1(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PWM_A_1)
    }
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_2(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_2)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_2(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_2)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_2(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_2)
    }
    #[doc = "`1001`"]
    #[inline(always)]
