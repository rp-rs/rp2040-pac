#[doc = "Reader of register GPIO7_CTRL"]
pub type R = crate::R<u32, super::GPIO7_CTRL>;
#[doc = "Writer for register GPIO7_CTRL"]
pub type W = crate::W<u32, super::GPIO7_CTRL>;
#[doc = "Register GPIO7_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO7_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        use crate::Variant::*;
        match self.bits {
            1 => Val(FUNCSEL_A::SPI0_TX),
            2 => Val(FUNCSEL_A::UART1_RTS),
            3 => Val(FUNCSEL_A::I2C1_SCL),
            4 => Val(FUNCSEL_A::PWM_B_3),
            5 => Val(FUNCSEL_A::SIO_7),
            6 => Val(FUNCSEL_A::PIO0_7),
            7 => Val(FUNCSEL_A::PIO1_7),
            8 => Val(FUNCSEL_A::USB_MUXING_EXTPHY_OE_N),
    ...
    #[doc = "Checks if the value of the field is `PWM_B_3`"]
    #[inline(always)]
    pub fn is_pwm_b_3(&self) -> bool {
        *self == FUNCSEL_A::PWM_B_3
    }
    #[doc = "Checks if the value of the field is `SIO_7`"]
    #[inline(always)]
    pub fn is_sio_7(&self) -> bool {
        *self == FUNCSEL_A::SIO_7
    }
    #[doc = "Checks if the value of the field is `PIO0_7`"]
    #[inline(always)]
    pub fn is_pio0_7(&self) -> bool {
        *self == FUNCSEL_A::PIO0_7
    }
    #[doc = "Checks if the value of the field is `PIO1_7`"]
    #[inline(always)]
    pub fn is_pio1_7(&self) -> bool {
        *self == FUNCSEL_A::PIO1_7
    }
    #[doc = "Checks if the value of the field is `USB_MUXING_EXTPHY_OE_N`"]
    #[inline(always)]
    pub fn is_usb_muxing_extphy_oe_n(&self) -> bool {
        *self == FUNCSEL_A::USB_MUXING_EXTPHY_OE_N
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    pub fn spi0_tx(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SPI0_TX)
    }
    #[doc = "`10`"]
    #[inline(always)]
    pub fn uart1_rts(self) -> &'a mut W {
        self.variant(FUNCSEL_A::UART1_RTS)
    }
    #[doc = "`11`"]
    #[inline(always)]
    ...
    #[doc = "`100`"]
    #[inline(always)]
    pub fn pwm_b_3(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PWM_B_3)
    }
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_7(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_7)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_7(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_7)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_7(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_7)
    }
    #[doc = "`1000`"]
    #[inline(always)]
    pub fn usb_muxing_extphy_oe_n(self) -> &'a mut W {
        self.variant(FUNCSEL_A::USB_MUXING_EXTPHY_OE_N)
    }
    #[doc = "`1001`"]
    #[inline(always)]
