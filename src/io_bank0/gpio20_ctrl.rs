#[doc = "Reader of register GPIO20_CTRL"]
pub type R = crate::R<u32, super::GPIO20_CTRL>;
#[doc = "Writer for register GPIO20_CTRL"]
pub type W = crate::W<u32, super::GPIO20_CTRL>;
#[doc = "Register GPIO20_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO20_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        ...
        match self.bits {
            ...
            4 => Val(FUNCSEL_A::PWM_A_2),
            5 => Val(FUNCSEL_A::SIO_20),
            6 => Val(FUNCSEL_A::PIO0_20),
            7 => Val(FUNCSEL_A::PIO1_20),
            8 => Val(FUNCSEL_A::CLOCKS_GPIN_0),
    ...
    #[doc = "Checks if the value of the field is `PWM_A_2`"]
    #[inline(always)]
    pub fn is_pwm_a_2(&self) -> bool {
        *self == FUNCSEL_A::PWM_A_2
    }
    #[doc = "Checks if the value of the field is `SIO_20`"]
    #[inline(always)]
    pub fn is_sio_20(&self) -> bool {
        *self == FUNCSEL_A::SIO_20
    }
    #[doc = "Checks if the value of the field is `PIO0_20`"]
    #[inline(always)]
    pub fn is_pio0_20(&self) -> bool {
        *self == FUNCSEL_A::PIO0_20
    }
    #[doc = "Checks if the value of the field is `PIO1_20`"]
    #[inline(always)]
    pub fn is_pio1_20(&self) -> bool {
        *self == FUNCSEL_A::PIO1_20
    }
    #[doc = "Checks if the value of the field is `CLOCKS_GPIN_0`"]
    #[inline(always)]
    pub fn is_clocks_gpin_0(&self) -> bool {
        *self == FUNCSEL_A::CLOCKS_GPIN_0
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`100`"]
    #[inline(always)]
    pub fn pwm_a_2(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PWM_A_2)
    }
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_20(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_20)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_20(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_20)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_20(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_20)
    }
    #[doc = "`1000`"]
    #[inline(always)]
    pub fn clocks_gpin_0(self) -> &'a mut W {
        self.variant(FUNCSEL_A::CLOCKS_GPIN_0)
    }
    #[doc = "`1001`"]
    #[inline(always)]
