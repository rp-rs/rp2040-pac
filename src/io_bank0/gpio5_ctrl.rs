#[doc = "Reader of register GPIO5_CTRL"]
pub type R = crate::R<u32, super::GPIO5_CTRL>;
#[doc = "Writer for register GPIO5_CTRL"]
pub type W = crate::W<u32, super::GPIO5_CTRL>;
#[doc = "Register GPIO5_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO5_CTRL {
    type Type = u32;
    #[inline(always)]
