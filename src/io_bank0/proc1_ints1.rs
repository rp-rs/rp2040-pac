#[doc = "Register `PROC1_INTS1` reader"]
pub struct R(crate::R<PROC1_INTS1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PROC1_INTS1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PROC1_INTS1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PROC1_INTS1_SPEC>) -> Self {
        R(reader)
    }
}
...
For information about available fields see [proc1_ints1](index.html) module"]
pub struct PROC1_INTS1_SPEC;
impl crate::RegisterSpec for PROC1_INTS1_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [proc1_ints1::R](R) reader structure"]
impl crate::Readable for PROC1_INTS1_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PROC1_INTS1 to value 0"]
impl crate::Resettable for PROC1_INTS1_SPEC {
    #[inline(always)]
