...
pub type GPIO0_EDGE_LOW_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
#[doc = "Field `GPIO0_EDGE_HIGH` reader - "]
pub type GPIO0_EDGE_HIGH_R = crate::BitReader;
#[doc = "Field `GPIO0_EDGE_HIGH` writer - "]
pub type GPIO0_EDGE_HIGH_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO1_EDGE_LOW_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
#[doc = "Field `GPIO1_EDGE_HIGH` reader - "]
pub type GPIO1_EDGE_HIGH_R = crate::BitReader;
#[doc = "Field `GPIO1_EDGE_HIGH` writer - "]
pub type GPIO1_EDGE_HIGH_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO2_EDGE_LOW_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
#[doc = "Field `GPIO2_EDGE_HIGH` reader - "]
pub type GPIO2_EDGE_HIGH_R = crate::BitReader;
#[doc = "Field `GPIO2_EDGE_HIGH` writer - "]
pub type GPIO2_EDGE_HIGH_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO3_EDGE_LOW_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
#[doc = "Field `GPIO3_EDGE_HIGH` reader - "]
pub type GPIO3_EDGE_HIGH_R = crate::BitReader;
#[doc = "Field `GPIO3_EDGE_HIGH` writer - "]
pub type GPIO3_EDGE_HIGH_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO4_EDGE_LOW_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
#[doc = "Field `GPIO4_EDGE_HIGH` reader - "]
pub type GPIO4_EDGE_HIGH_R = crate::BitReader;
#[doc = "Field `GPIO4_EDGE_HIGH` writer - "]
pub type GPIO4_EDGE_HIGH_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO5_EDGE_LOW_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
#[doc = "Field `GPIO5_EDGE_HIGH` reader - "]
pub type GPIO5_EDGE_HIGH_R = crate::BitReader;
#[doc = "Field `GPIO5_EDGE_HIGH` writer - "]
pub type GPIO5_EDGE_HIGH_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO6_EDGE_LOW_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
#[doc = "Field `GPIO6_EDGE_HIGH` reader - "]
pub type GPIO6_EDGE_HIGH_R = crate::BitReader;
#[doc = "Field `GPIO6_EDGE_HIGH` writer - "]
pub type GPIO6_EDGE_HIGH_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type GPIO7_EDGE_LOW_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
#[doc = "Field `GPIO7_EDGE_HIGH` reader - "]
pub type GPIO7_EDGE_HIGH_R = crate::BitReader;
#[doc = "Field `GPIO7_EDGE_HIGH` writer - "]
pub type GPIO7_EDGE_HIGH_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
impl R {
    #[doc = "Bit 0"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn gpio0_edge_low(&mut self) -> GPIO0_EDGE_LOW_W<INTR_SPEC, 2> {
        GPIO0_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    #[must_use]
    pub fn gpio0_edge_high(&mut self) -> GPIO0_EDGE_HIGH_W<INTR_SPEC, 3> {
        GPIO0_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 6"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1_edge_low(&mut self) -> GPIO1_EDGE_LOW_W<INTR_SPEC, 6> {
        GPIO1_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 7"]
    #[inline(always)]
    #[must_use]
    pub fn gpio1_edge_high(&mut self) -> GPIO1_EDGE_HIGH_W<INTR_SPEC, 7> {
        GPIO1_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 10"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2_edge_low(&mut self) -> GPIO2_EDGE_LOW_W<INTR_SPEC, 10> {
        GPIO2_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 11"]
    #[inline(always)]
    #[must_use]
    pub fn gpio2_edge_high(&mut self) -> GPIO2_EDGE_HIGH_W<INTR_SPEC, 11> {
        GPIO2_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 14"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3_edge_low(&mut self) -> GPIO3_EDGE_LOW_W<INTR_SPEC, 14> {
        GPIO3_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 15"]
    #[inline(always)]
    #[must_use]
    pub fn gpio3_edge_high(&mut self) -> GPIO3_EDGE_HIGH_W<INTR_SPEC, 15> {
        GPIO3_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 18"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4_edge_low(&mut self) -> GPIO4_EDGE_LOW_W<INTR_SPEC, 18> {
        GPIO4_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 19"]
    #[inline(always)]
    #[must_use]
    pub fn gpio4_edge_high(&mut self) -> GPIO4_EDGE_HIGH_W<INTR_SPEC, 19> {
        GPIO4_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 22"]
    #[inline(always)]
    #[must_use]
    pub fn gpio5_edge_low(&mut self) -> GPIO5_EDGE_LOW_W<INTR_SPEC, 22> {
        GPIO5_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 23"]
    #[inline(always)]
    #[must_use]
    pub fn gpio5_edge_high(&mut self) -> GPIO5_EDGE_HIGH_W<INTR_SPEC, 23> {
        GPIO5_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 26"]
    #[inline(always)]
    #[must_use]
    pub fn gpio6_edge_low(&mut self) -> GPIO6_EDGE_LOW_W<INTR_SPEC, 26> {
        GPIO6_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 27"]
    #[inline(always)]
    #[must_use]
    pub fn gpio6_edge_high(&mut self) -> GPIO6_EDGE_HIGH_W<INTR_SPEC, 27> {
        GPIO6_EDGE_HIGH_W::new(self)
    }
    #[doc = "Bit 30"]
    #[inline(always)]
    #[must_use]
    pub fn gpio7_edge_low(&mut self) -> GPIO7_EDGE_LOW_W<INTR_SPEC, 30> {
        GPIO7_EDGE_LOW_W::new(self)
    }
    #[doc = "Bit 31"]
    #[inline(always)]
    #[must_use]
    pub fn gpio7_edge_high(&mut self) -> GPIO7_EDGE_HIGH_W<INTR_SPEC, 31> {
