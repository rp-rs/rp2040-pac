#[doc = "Reader of register GPIO22_CTRL"]
pub type R = crate::R<u32, super::GPIO22_CTRL>;
#[doc = "Writer for register GPIO22_CTRL"]
pub type W = crate::W<u32, super::GPIO22_CTRL>;
#[doc = "Register GPIO22_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO22_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        ...
        match self.bits {
            ...
            5 => Val(FUNCSEL_A::SIO_22),
            6 => Val(FUNCSEL_A::PIO0_22),
            7 => Val(FUNCSEL_A::PIO1_22),
            8 => Val(FUNCSEL_A::CLOCKS_GPIN_1),
    ...
    #[doc = "Checks if the value of the field is `SIO_22`"]
    #[inline(always)]
    pub fn is_sio_22(&self) -> bool {
        *self == FUNCSEL_A::SIO_22
    }
    #[doc = "Checks if the value of the field is `PIO0_22`"]
    #[inline(always)]
    pub fn is_pio0_22(&self) -> bool {
        *self == FUNCSEL_A::PIO0_22
    }
    #[doc = "Checks if the value of the field is `PIO1_22`"]
    #[inline(always)]
    pub fn is_pio1_22(&self) -> bool {
        *self == FUNCSEL_A::PIO1_22
    }
    #[doc = "Checks if the value of the field is `CLOCKS_GPIN_1`"]
    #[inline(always)]
    pub fn is_clocks_gpin_1(&self) -> bool {
        *self == FUNCSEL_A::CLOCKS_GPIN_1
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_22(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_22)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_22(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_22)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_22(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_22)
    }
    #[doc = "`1000`"]
    #[inline(always)]
    pub fn clocks_gpin_1(self) -> &'a mut W {
        self.variant(FUNCSEL_A::CLOCKS_GPIN_1)
    }
    #[doc = "`1001`"]
    #[inline(always)]
