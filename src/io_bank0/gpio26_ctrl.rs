#[doc = "Reader of register GPIO26_CTRL"]
pub type R = crate::R<u32, super::GPIO26_CTRL>;
#[doc = "Writer for register GPIO26_CTRL"]
pub type W = crate::W<u32, super::GPIO26_CTRL>;
#[doc = "Register GPIO26_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO26_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        ...
        match self.bits {
            ...
            5 => Val(FUNCSEL_A::SIO_26),
            6 => Val(FUNCSEL_A::PIO0_26),
            7 => Val(FUNCSEL_A::PIO1_26),
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_26(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_26)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_26(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_26)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_26(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_26)
    }
    #[doc = "`1001`"]
    #[inline(always)]
