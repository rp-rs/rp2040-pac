#[doc = "Reader of register GPIO12_CTRL"]
pub type R = crate::R<u32, super::GPIO12_CTRL>;
#[doc = "Writer for register GPIO12_CTRL"]
pub type W = crate::W<u32, super::GPIO12_CTRL>;
#[doc = "Register GPIO12_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO12_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        ...
        match self.bits {
            ...
            5 => Val(FUNCSEL_A::SIO_12),
            6 => Val(FUNCSEL_A::PIO0_12),
            7 => Val(FUNCSEL_A::PIO1_12),
            8 => Val(FUNCSEL_A::USB_MUXING_EXTPHY_SPEED),
    ...
    #[doc = "Checks if the value of the field is `SIO_12`"]
    #[inline(always)]
    pub fn is_sio_12(&self) -> bool {
        *self == FUNCSEL_A::SIO_12
    }
    #[doc = "Checks if the value of the field is `PIO0_12`"]
    #[inline(always)]
    pub fn is_pio0_12(&self) -> bool {
        *self == FUNCSEL_A::PIO0_12
    }
    #[doc = "Checks if the value of the field is `PIO1_12`"]
    #[inline(always)]
    pub fn is_pio1_12(&self) -> bool {
        *self == FUNCSEL_A::PIO1_12
    }
    #[doc = "Checks if the value of the field is `USB_MUXING_EXTPHY_SPEED`"]
    #[inline(always)]
    pub fn is_usb_muxing_extphy_speed(&self) -> bool {
        *self == FUNCSEL_A::USB_MUXING_EXTPHY_SPEED
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_12(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_12)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_12(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_12)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_12(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_12)
    }
    #[doc = "`1000`"]
    #[inline(always)]
    pub fn usb_muxing_extphy_speed(self) -> &'a mut W {
        self.variant(FUNCSEL_A::USB_MUXING_EXTPHY_SPEED)
    }
    #[doc = "`1001`"]
    #[inline(always)]
