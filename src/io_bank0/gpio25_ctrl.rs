#[doc = "Reader of register GPIO25_CTRL"]
pub type R = crate::R<u32, super::GPIO25_CTRL>;
#[doc = "Writer for register GPIO25_CTRL"]
pub type W = crate::W<u32, super::GPIO25_CTRL>;
#[doc = "Register GPIO25_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO25_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        ...
        match self.bits {
            ...
            5 => Val(FUNCSEL_A::SIO_25),
            6 => Val(FUNCSEL_A::PIO0_25),
            7 => Val(FUNCSEL_A::PIO1_25),
            8 => Val(FUNCSEL_A::CLOCKS_GPOUT_3),
    ...
    #[doc = "Checks if the value of the field is `SIO_25`"]
    #[inline(always)]
    pub fn is_sio_25(&self) -> bool {
        *self == FUNCSEL_A::SIO_25
    }
    #[doc = "Checks if the value of the field is `PIO0_25`"]
    #[inline(always)]
    pub fn is_pio0_25(&self) -> bool {
        *self == FUNCSEL_A::PIO0_25
    }
    #[doc = "Checks if the value of the field is `PIO1_25`"]
    #[inline(always)]
    pub fn is_pio1_25(&self) -> bool {
        *self == FUNCSEL_A::PIO1_25
    }
    #[doc = "Checks if the value of the field is `CLOCKS_GPOUT_3`"]
    #[inline(always)]
    pub fn is_clocks_gpout_3(&self) -> bool {
        *self == FUNCSEL_A::CLOCKS_GPOUT_3
    }
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_25(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_25)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_25(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_25)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_25(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_25)
    }
    #[doc = "`1000`"]
    #[inline(always)]
    pub fn clocks_gpout_3(self) -> &'a mut W {
        self.variant(FUNCSEL_A::CLOCKS_GPOUT_3)
    }
    #[doc = "`1001`"]
    #[inline(always)]
