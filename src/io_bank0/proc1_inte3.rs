#[doc = "Reader of register PROC1_INTE3"]
pub type R = crate::R<u32, super::PROC1_INTE3>;
#[doc = "Writer for register PROC1_INTE3"]
pub type W = crate::W<u32, super::PROC1_INTE3>;
#[doc = "Register PROC1_INTE3 `reset()`'s with value 0"]
impl crate::ResetValue for super::PROC1_INTE3 {
    type Type = u32;
    #[inline(always)]
