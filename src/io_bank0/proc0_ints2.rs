#[doc = "Register `PROC0_INTS2` reader"]
pub struct R(crate::R<PROC0_INTS2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<PROC0_INTS2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<PROC0_INTS2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<PROC0_INTS2_SPEC>) -> Self {
        R(reader)
    }
}
...
For information about available fields see [proc0_ints2](index.html) module"]
pub struct PROC0_INTS2_SPEC;
impl crate::RegisterSpec for PROC0_INTS2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [proc0_ints2::R](R) reader structure"]
impl crate::Readable for PROC0_INTS2_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets PROC0_INTS2 to value 0"]
impl crate::Resettable for PROC0_INTS2_SPEC {
    #[inline(always)]
