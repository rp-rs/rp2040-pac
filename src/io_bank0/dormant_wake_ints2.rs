#[doc = "Register `DORMANT_WAKE_INTS2` reader"]
pub struct R(crate::R<DORMANT_WAKE_INTS2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<DORMANT_WAKE_INTS2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<DORMANT_WAKE_INTS2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<DORMANT_WAKE_INTS2_SPEC>) -> Self {
        R(reader)
    }
}
...
For information about available fields see [dormant_wake_ints2](index.html) module"]
pub struct DORMANT_WAKE_INTS2_SPEC;
impl crate::RegisterSpec for DORMANT_WAKE_INTS2_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [dormant_wake_ints2::R](R) reader structure"]
impl crate::Readable for DORMANT_WAKE_INTS2_SPEC {
    type Reader = R;
}
#[doc = "`reset()` method sets DORMANT_WAKE_INTS2 to value 0"]
impl crate::Resettable for DORMANT_WAKE_INTS2_SPEC {
    #[inline(always)]
