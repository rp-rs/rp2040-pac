#[doc = "Reader of register GPIO19_CTRL"]
pub type R = crate::R<u32, super::GPIO19_CTRL>;
#[doc = "Writer for register GPIO19_CTRL"]
pub type W = crate::W<u32, super::GPIO19_CTRL>;
#[doc = "Register GPIO19_CTRL `reset()`'s with value 0x1f"]
impl crate::ResetValue for super::GPIO19_CTRL {
    type Type = u32;
    #[inline(always)]
...
impl FUNCSEL_R {
    ...
    pub fn variant(&self) -> crate::Variant<u8, FUNCSEL_A> {
        ...
        match self.bits {
            ...
            5 => Val(FUNCSEL_A::SIO_19),
            6 => Val(FUNCSEL_A::PIO0_19),
            7 => Val(FUNCSEL_A::PIO1_19),
...
impl<'a> FUNCSEL_W<'a> {
    ...
    #[doc = "`101`"]
    #[inline(always)]
    pub fn sio_19(self) -> &'a mut W {
        self.variant(FUNCSEL_A::SIO_19)
    }
    #[doc = "`110`"]
    #[inline(always)]
    pub fn pio0_19(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO0_19)
    }
    #[doc = "`111`"]
    #[inline(always)]
    pub fn pio1_19(self) -> &'a mut W {
        self.variant(FUNCSEL_A::PIO1_19)
    }
    #[doc = "`1001`"]
    #[inline(always)]
