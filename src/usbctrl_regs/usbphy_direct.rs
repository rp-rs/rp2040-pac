...
pub type DP_PULLUP_HISEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DP_PULLUP_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DP_PULLDN_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DM_PULLUP_HISEL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DM_PULLUP_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DM_PULLDN_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
#[doc = "Field `TX_DP_OE` writer - Output enable. If TX_DIFFMODE=1, OE for DPP/DPM diff pair. 0 - DPP/DPM in Hi-Z state; 1 - DPP/DPM driving  
 If TX_DIFFMODE=0, OE for DPP only. 0 - DPP in Hi-Z state; 1 - DPP driving"]
pub type TX_DP_OE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
#[doc = "Field `TX_DM_OE` writer - Output enable. If TX_DIFFMODE=1, Ignored.  
 If TX_DIFFMODE=0, OE for DPM only. 0 - DPM in Hi-Z state; 1 - DPM driving"]
pub type TX_DM_OE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RX_PD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TX_PD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
#[doc = "Field `TX_FSSLEW` writer - TX_FSSLEW=0: Low speed slew rate  
 TX_FSSLEW=1: Full speed slew rate"]
pub type TX_FSSLEW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
#[doc = "Field `TX_DIFFMODE` writer - TX_DIFFMODE=0: Single ended mode  
 TX_DIFFMODE=1: Differential drive mode (TX_DM, TX_DM_OE ignored)"]
pub type TX_DIFFMODE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn dp_pullup_hisel(&mut self) -> DP_PULLUP_HISEL_W<USBPHY_DIRECT_SPEC, 0> {
        DP_PULLUP_HISEL_W::new(self)
    }
    #[doc = "Bit 1 - DP pull up enable"]
    #[inline(always)]
    #[must_use]
    pub fn dp_pullup_en(&mut self) -> DP_PULLUP_EN_W<USBPHY_DIRECT_SPEC, 1> {
        DP_PULLUP_EN_W::new(self)
    }
    #[doc = "Bit 2 - DP pull down enable"]
    #[inline(always)]
    #[must_use]
    pub fn dp_pulldn_en(&mut self) -> DP_PULLDN_EN_W<USBPHY_DIRECT_SPEC, 2> {
        DP_PULLDN_EN_W::new(self)
    }
    #[doc = "Bit 4 - Enable the second DM pull up resistor. 0 - Pull = Rpu2; 1 - Pull = Rpu1 + Rpu2"]
    #[inline(always)]
    #[must_use]
    pub fn dm_pullup_hisel(&mut self) -> DM_PULLUP_HISEL_W<USBPHY_DIRECT_SPEC, 4> {
        DM_PULLUP_HISEL_W::new(self)
    }
    #[doc = "Bit 5 - DM pull up enable"]
    #[inline(always)]
    #[must_use]
    pub fn dm_pullup_en(&mut self) -> DM_PULLUP_EN_W<USBPHY_DIRECT_SPEC, 5> {
        DM_PULLUP_EN_W::new(self)
    }
    #[doc = "Bit 6 - DM pull down enable"]
    #[inline(always)]
    #[must_use]
    pub fn dm_pulldn_en(&mut self) -> DM_PULLDN_EN_W<USBPHY_DIRECT_SPEC, 6> {
 ...
 If TX_DIFFMODE=0, OE for DPP only. 0 - DPP in Hi-Z state; 1 - DPP driving"]
    #[inline(always)]
    #[must_use]
    pub fn tx_dp_oe(&mut self) -> TX_DP_OE_W<USBPHY_DIRECT_SPEC, 8> {
        TX_DP_OE_W::new(self)
    }
    #[doc = "Bit 9 - Output enable. If TX_DIFFMODE=1, Ignored.  
 If TX_DIFFMODE=0, OE for DPM only. 0 - DPM in Hi-Z state; 1 - DPM driving"]
    #[inline(always)]
    #[must_use]
    pub fn tx_dm_oe(&mut self) -> TX_DM_OE_W<USBPHY_DIRECT_SPEC, 9> {
        TX_DM_OE_W::new(self)
    }
    #[doc = "Bit 10 - Output data. If TX_DIFFMODE=1, Drives DPP/DPM diff pair. TX_DP_OE=1 to enable drive. DPP=TX_DP, DPM=~TX_DP  
 If TX_DIFFMODE=0, Drives DPP only. TX_DP_OE=1 to enable drive. DPP=TX_DP"]
    #[inline(always)]
    #[must_use]
    pub fn tx_dp(&mut self) -> TX_DP_W<USBPHY_DIRECT_SPEC, 10> {
        TX_DP_W::new(self)
    }
    #[doc = "Bit 11 - Output data. TX_DIFFMODE=1, Ignored  
 TX_DIFFMODE=0, Drives DPM only. TX_DM_OE=1 to enable drive. DPM=TX_DM"]
    #[inline(always)]
    #[must_use]
    pub fn tx_dm(&mut self) -> TX_DM_W<USBPHY_DIRECT_SPEC, 11> {
        TX_DM_W::new(self)
    }
    #[doc = "Bit 12 - RX power down override (if override enable is set). 1 = powered down."]
    #[inline(always)]
    #[must_use]
    pub fn rx_pd(&mut self) -> RX_PD_W<USBPHY_DIRECT_SPEC, 12> {
        RX_PD_W::new(self)
    }
    #[doc = "Bit 13 - TX power down override (if override enable is set). 1 = powered down."]
    #[inline(always)]
    #[must_use]
    pub fn tx_pd(&mut self) -> TX_PD_W<USBPHY_DIRECT_SPEC, 13> {
        TX_PD_W::new(self)
    }
    #[doc = "Bit 14 - TX_FSSLEW=0: Low speed slew rate  
 TX_FSSLEW=1: Full speed slew rate"]
    #[inline(always)]
    #[must_use]
    pub fn tx_fsslew(&mut self) -> TX_FSSLEW_W<USBPHY_DIRECT_SPEC, 14> {
 ...
 TX_DIFFMODE=1: Differential drive mode (TX_DM, TX_DM_OE ignored)"]
    #[inline(always)]
    #[must_use]
    pub fn tx_diffmode(&mut self) -> TX_DIFFMODE_W<USBPHY_DIRECT_SPEC, 15> {
