...
pub type INT_EP_ACTIVE_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 15, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn int_ep_active(&mut self) -> INT_EP_ACTIVE_W<INT_EP_CTRL_SPEC, 1> {
