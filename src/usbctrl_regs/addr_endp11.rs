#[doc = "Register `ADDR_ENDP11` reader"]
pub struct R(crate::R<ADDR_ENDP11_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ADDR_ENDP11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ADDR_ENDP11_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ADDR_ENDP11_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ADDR_ENDP11` writer"]
pub struct W(crate::W<ADDR_ENDP11_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ADDR_ENDP11_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ADDR_ENDP11_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ADDR_ENDP11_SPEC>) -> Self {
        W(writer)
    }
}
...
For information about available fields see [addr_endp11](index.html) module"]
pub struct ADDR_ENDP11_SPEC;
impl crate::RegisterSpec for ADDR_ENDP11_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [addr_endp11::R](R) reader structure"]
impl crate::Readable for ADDR_ENDP11_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [addr_endp11::W](W) writer structure"]
impl crate::Writable for ADDR_ENDP11_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets ADDR_ENDP11 to value 0"]
impl crate::Resettable for ADDR_ENDP11_SPEC {
    #[inline(always)]
