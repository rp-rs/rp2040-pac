#[doc = "Reader of register ADDR_ENDP11"]
pub type R = crate::R<u32, super::ADDR_ENDP11>;
#[doc = "Writer for register ADDR_ENDP11"]
pub type W = crate::W<u32, super::ADDR_ENDP11>;
#[doc = "Register ADDR_ENDP11 `reset()`'s with value 0"]
impl crate::ResetValue for super::ADDR_ENDP11 {
    type Type = u32;
    #[inline(always)]
