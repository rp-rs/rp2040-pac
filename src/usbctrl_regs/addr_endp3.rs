#[doc = "Register `ADDR_ENDP3` reader"]
pub struct R(crate::R<ADDR_ENDP3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ADDR_ENDP3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ADDR_ENDP3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ADDR_ENDP3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ADDR_ENDP3` writer"]
pub struct W(crate::W<ADDR_ENDP3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ADDR_ENDP3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ADDR_ENDP3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ADDR_ENDP3_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADDRESS_W<'a, const O: u8> = crate::FieldWriter<'a, ADDR_ENDP3_SPEC, 7, O>;
...
pub type ENDPOINT_W<'a, const O: u8> = crate::FieldWriter<'a, ADDR_ENDP3_SPEC, 4, O>;
...
pub type INTEP_DIR_W<'a, const O: u8> = crate::BitWriter<'a, ADDR_ENDP3_SPEC, O>;
...
pub type INTEP_PREAMBLE_W<'a, const O: u8> = crate::BitWriter<'a, ADDR_ENDP3_SPEC, O>;
impl R {
...
For information about available fields see [addr_endp3](index.html) module"]
pub struct ADDR_ENDP3_SPEC;
impl crate::RegisterSpec for ADDR_ENDP3_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [addr_endp3::R](R) reader structure"]
impl crate::Readable for ADDR_ENDP3_SPEC {
    type Reader = R;
}
