#[doc = "Reader of register ADDR_ENDP12"]
pub type R = crate::R<u32, super::ADDR_ENDP12>;
#[doc = "Writer for register ADDR_ENDP12"]
pub type W = crate::W<u32, super::ADDR_ENDP12>;
#[doc = "Register ADDR_ENDP12 `reset()`'s with value 0"]
impl crate::ResetValue for super::ADDR_ENDP12 {
    type Type = u32;
    #[inline(always)]
