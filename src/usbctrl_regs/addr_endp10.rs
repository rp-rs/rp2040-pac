#[doc = "Reader of register ADDR_ENDP10"]
pub type R = crate::R<u32, super::ADDR_ENDP10>;
#[doc = "Writer for register ADDR_ENDP10"]
pub type W = crate::W<u32, super::ADDR_ENDP10>;
#[doc = "Register ADDR_ENDP10 `reset()`'s with value 0"]
impl crate::ResetValue for super::ADDR_ENDP10 {
    type Type = u32;
    #[inline(always)]
