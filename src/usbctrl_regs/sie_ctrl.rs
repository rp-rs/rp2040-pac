...
pub type START_TRANS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SEND_SETUP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SEND_DATA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RECEIVE_DATA_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type STOP_TRANS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PREAMBLE_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SOF_SYNC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SOF_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type KEEP_ALIVE_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RESET_BUS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PULLDOWN_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PULLUP_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type RPU_OPT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TRANSCEIVER_PD_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DIRECT_DM_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DIRECT_DP_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DIRECT_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EP0_INT_NAK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EP0_INT_2BUF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EP0_INT_1BUF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EP0_DOUBLE_BUF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EP0_INT_STALL_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn start_trans(&mut self) -> START_TRANS_W<SIE_CTRL_SPEC, 0> {
        START_TRANS_W::new(self)
    }
    #[doc = "Bit 1 - Host: Send Setup packet"]
    #[inline(always)]
    #[must_use]
    pub fn send_setup(&mut self) -> SEND_SETUP_W<SIE_CTRL_SPEC, 1> {
        SEND_SETUP_W::new(self)
    }
    #[doc = "Bit 2 - Host: Send transaction (OUT from host)"]
    #[inline(always)]
    #[must_use]
    pub fn send_data(&mut self) -> SEND_DATA_W<SIE_CTRL_SPEC, 2> {
        SEND_DATA_W::new(self)
    }
    #[doc = "Bit 3 - Host: Receive transaction (IN to host)"]
    #[inline(always)]
    #[must_use]
    pub fn receive_data(&mut self) -> RECEIVE_DATA_W<SIE_CTRL_SPEC, 3> {
        RECEIVE_DATA_W::new(self)
    }
    #[doc = "Bit 4 - Host: Stop transaction"]
    #[inline(always)]
    #[must_use]
    pub fn stop_trans(&mut self) -> STOP_TRANS_W<SIE_CTRL_SPEC, 4> {
        STOP_TRANS_W::new(self)
    }
    #[doc = "Bit 6 - Host: Preable enable for LS device on FS hub"]
    #[inline(always)]
    #[must_use]
    pub fn preamble_en(&mut self) -> PREAMBLE_EN_W<SIE_CTRL_SPEC, 6> {
        PREAMBLE_EN_W::new(self)
    }
    #[doc = "Bit 8 - Host: Delay packet(s) until after SOF"]
    #[inline(always)]
    #[must_use]
    pub fn sof_sync(&mut self) -> SOF_SYNC_W<SIE_CTRL_SPEC, 8> {
        SOF_SYNC_W::new(self)
    }
    #[doc = "Bit 9 - Host: Enable SOF generation (for full speed bus)"]
    #[inline(always)]
    #[must_use]
    pub fn sof_en(&mut self) -> SOF_EN_W<SIE_CTRL_SPEC, 9> {
        SOF_EN_W::new(self)
    }
    #[doc = "Bit 10 - Host: Enable keep alive packet (for low speed bus)"]
    #[inline(always)]
    #[must_use]
    pub fn keep_alive_en(&mut self) -> KEEP_ALIVE_EN_W<SIE_CTRL_SPEC, 10> {
        KEEP_ALIVE_EN_W::new(self)
    }
    #[doc = "Bit 11 - Host: Enable VBUS"]
    #[inline(always)]
    #[must_use]
    pub fn vbus_en(&mut self) -> VBUS_EN_W<SIE_CTRL_SPEC, 11> {
        VBUS_EN_W::new(self)
    }
    #[doc = "Bit 12 - Device: Remote wakeup. Device can initiate its own resume after suspend."]
    #[inline(always)]
    #[must_use]
    pub fn resume(&mut self) -> RESUME_W<SIE_CTRL_SPEC, 12> {
        RESUME_W::new(self)
    }
    #[doc = "Bit 13 - Host: Reset bus"]
    #[inline(always)]
    #[must_use]
    pub fn reset_bus(&mut self) -> RESET_BUS_W<SIE_CTRL_SPEC, 13> {
        RESET_BUS_W::new(self)
    }
    #[doc = "Bit 15 - Host: Enable pull down resistors"]
    #[inline(always)]
    #[must_use]
    pub fn pulldown_en(&mut self) -> PULLDOWN_EN_W<SIE_CTRL_SPEC, 15> {
        PULLDOWN_EN_W::new(self)
    }
    #[doc = "Bit 16 - Device: Enable pull up resistor"]
    #[inline(always)]
    #[must_use]
    pub fn pullup_en(&mut self) -> PULLUP_EN_W<SIE_CTRL_SPEC, 16> {
        PULLUP_EN_W::new(self)
    }
    #[doc = "Bit 17 - Device: Pull-up strength (0=1K2, 1=2k3)"]
    #[inline(always)]
    #[must_use]
    pub fn rpu_opt(&mut self) -> RPU_OPT_W<SIE_CTRL_SPEC, 17> {
        RPU_OPT_W::new(self)
    }
    #[doc = "Bit 18 - Power down bus transceiver"]
    #[inline(always)]
    #[must_use]
    pub fn transceiver_pd(&mut self) -> TRANSCEIVER_PD_W<SIE_CTRL_SPEC, 18> {
        TRANSCEIVER_PD_W::new(self)
    }
    #[doc = "Bit 24 - Direct control of DM"]
    #[inline(always)]
    #[must_use]
    pub fn direct_dm(&mut self) -> DIRECT_DM_W<SIE_CTRL_SPEC, 24> {
        DIRECT_DM_W::new(self)
    }
    #[doc = "Bit 25 - Direct control of DP"]
    #[inline(always)]
    #[must_use]
    pub fn direct_dp(&mut self) -> DIRECT_DP_W<SIE_CTRL_SPEC, 25> {
        DIRECT_DP_W::new(self)
    }
    #[doc = "Bit 26 - Direct bus drive enable"]
    #[inline(always)]
    #[must_use]
    pub fn direct_en(&mut self) -> DIRECT_EN_W<SIE_CTRL_SPEC, 26> {
        DIRECT_EN_W::new(self)
    }
    #[doc = "Bit 27 - Device: Set bit in EP_STATUS_STALL_NAK when EP0 sends a NAK"]
    #[inline(always)]
    #[must_use]
    pub fn ep0_int_nak(&mut self) -> EP0_INT_NAK_W<SIE_CTRL_SPEC, 27> {
        EP0_INT_NAK_W::new(self)
    }
    #[doc = "Bit 28 - Device: Set bit in BUFF_STATUS for every 2 buffers completed on EP0"]
    #[inline(always)]
    #[must_use]
    pub fn ep0_int_2buf(&mut self) -> EP0_INT_2BUF_W<SIE_CTRL_SPEC, 28> {
        EP0_INT_2BUF_W::new(self)
    }
    #[doc = "Bit 29 - Device: Set bit in BUFF_STATUS for every buffer completed on EP0"]
    #[inline(always)]
    #[must_use]
    pub fn ep0_int_1buf(&mut self) -> EP0_INT_1BUF_W<SIE_CTRL_SPEC, 29> {
        EP0_INT_1BUF_W::new(self)
    }
    #[doc = "Bit 30 - Device: EP0 single buffered = 0, double buffered = 1"]
    #[inline(always)]
    #[must_use]
    pub fn ep0_double_buf(&mut self) -> EP0_DOUBLE_BUF_W<SIE_CTRL_SPEC, 30> {
        EP0_DOUBLE_BUF_W::new(self)
    }
    #[doc = "Bit 31 - Device: Set bit in EP_STATUS_STALL_NAK when EP0 sends a STALL"]
    #[inline(always)]
    #[must_use]
    pub fn ep0_int_stall(&mut self) -> EP0_INT_STALL_W<SIE_CTRL_SPEC, 31> {
