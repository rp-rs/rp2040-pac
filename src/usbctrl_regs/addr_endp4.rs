...
pub type ADDRESS_W<'a, const O: u8> = crate::FieldWriter<'a, ADDR_ENDP4_SPEC, 7, O>;
...
pub type ENDPOINT_W<'a, const O: u8> = crate::FieldWriter<'a, ADDR_ENDP4_SPEC, 4, O>;
...
pub type INTEP_DIR_W<'a, const O: u8> = crate::BitWriter<'a, ADDR_ENDP4_SPEC, O>;
...
pub type INTEP_PREAMBLE_W<'a, const O: u8> = crate::BitWriter<'a, ADDR_ENDP4_SPEC, O>;
impl R {
