...
pub type SUSPENDED_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type RESUME_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type CONNECTED_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type SETUP_REC_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
 ...
 * A setup packet is sent when no data in or data out transaction follows * An IN packet is received and the `LAST_BUFF` bit is set in the buffer control register * An IN packet is received with zero length * An OUT packet is sent and the `LAST_BUFF` bit is set"]
pub type TRANS_COMPLETE_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type BUS_RESET_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type CRC_ERROR_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type BIT_STUFF_ERROR_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type RX_OVERFLOW_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type RX_TIMEOUT_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
#[doc = "Field `NAK_REC` reader - Host: NAK received"]
pub type NAK_REC_R = crate::BitReader;
#[doc = "Field `NAK_REC` writer - Host: NAK received"]
pub type NAK_REC_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type STALL_REC_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
...
pub type ACK_REC_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
 ...
 * An IN packet from the device has the wrong data PID"]
pub type DATA_SEQ_ERROR_W<'a, REG, const O: u8> = crate::BitWriter1C<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn suspended(&mut self) -> SUSPENDED_W<SIE_STATUS_SPEC, 4> {
        SUSPENDED_W::new(self)
    }
    #[doc = "Bits 8:9 - Host: device speed. Disconnected = 00, LS = 01, FS = 10"]
    #[inline(always)]
    #[must_use]
    pub fn speed(&mut self) -> SPEED_W<SIE_STATUS_SPEC, 8> {
        SPEED_W::new(self)
    }
    #[doc = "Bit 11 - Host: Device has initiated a remote resume. Device: host has initiated a resume."]
    #[inline(always)]
    #[must_use]
    pub fn resume(&mut self) -> RESUME_W<SIE_STATUS_SPEC, 11> {
        RESUME_W::new(self)
    }
    #[doc = "Bit 16 - Device: connected"]
    #[inline(always)]
    #[must_use]
    pub fn connected(&mut self) -> CONNECTED_W<SIE_STATUS_SPEC, 16> {
        CONNECTED_W::new(self)
    }
    #[doc = "Bit 17 - Device: Setup packet received"]
    #[inline(always)]
    #[must_use]
    pub fn setup_rec(&mut self) -> SETUP_REC_W<SIE_STATUS_SPEC, 17> {
 ...
 * A setup packet is sent when no data in or data out transaction follows * An IN packet is received and the `LAST_BUFF` bit is set in the buffer control register * An IN packet is received with zero length * An OUT packet is sent and the `LAST_BUFF` bit is set"]
    #[inline(always)]
    #[must_use]
    pub fn trans_complete(&mut self) -> TRANS_COMPLETE_W<SIE_STATUS_SPEC, 18> {
        TRANS_COMPLETE_W::new(self)
    }
    #[doc = "Bit 19 - Device: bus reset received"]
    #[inline(always)]
    #[must_use]
    pub fn bus_reset(&mut self) -> BUS_RESET_W<SIE_STATUS_SPEC, 19> {
        BUS_RESET_W::new(self)
    }
    #[doc = "Bit 24 - CRC Error. Raised by the Serial RX engine."]
    #[inline(always)]
    #[must_use]
    pub fn crc_error(&mut self) -> CRC_ERROR_W<SIE_STATUS_SPEC, 24> {
        CRC_ERROR_W::new(self)
    }
    #[doc = "Bit 25 - Bit Stuff Error. Raised by the Serial RX engine."]
    #[inline(always)]
    #[must_use]
    pub fn bit_stuff_error(&mut self) -> BIT_STUFF_ERROR_W<SIE_STATUS_SPEC, 25> {
        BIT_STUFF_ERROR_W::new(self)
    }
    #[doc = "Bit 26 - RX overflow is raised by the Serial RX engine if the incoming data is too fast."]
    #[inline(always)]
    #[must_use]
    pub fn rx_overflow(&mut self) -> RX_OVERFLOW_W<SIE_STATUS_SPEC, 26> {
        RX_OVERFLOW_W::new(self)
    }
    #[doc = "Bit 27 - RX timeout is raised by both the host and device if an ACK is not received in the maximum time specified by the USB spec."]
    #[inline(always)]
    #[must_use]
    pub fn rx_timeout(&mut self) -> RX_TIMEOUT_W<SIE_STATUS_SPEC, 27> {
        RX_TIMEOUT_W::new(self)
    }
    #[doc = "Bit 28 - Host: NAK received"]
    #[inline(always)]
    #[must_use]
    pub fn nak_rec(&mut self) -> NAK_REC_W<SIE_STATUS_SPEC, 28> {
        NAK_REC_W::new(self)
    }
    #[doc = "Bit 29 - Host: STALL received"]
    #[inline(always)]
    #[must_use]
    pub fn stall_rec(&mut self) -> STALL_REC_W<SIE_STATUS_SPEC, 29> {
        STALL_REC_W::new(self)
    }
    #[doc = "Bit 30 - ACK received. Raised by both host and device."]
    #[inline(always)]
    #[must_use]
    pub fn ack_rec(&mut self) -> ACK_REC_W<SIE_STATUS_SPEC, 30> {
        ACK_REC_W::new(self)
    }
    #[doc = "Bit 31 - Data Sequence Error.  
 ...
 * An IN packet from the device has the wrong data PID"]
    #[inline(always)]
    #[must_use]
    pub fn data_seq_error(&mut self) -> DATA_SEQ_ERROR_W<SIE_STATUS_SPEC, 31> {
