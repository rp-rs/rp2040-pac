#[doc = "Reader of register ADDR_ENDP2"]
pub type R = crate::R<u32, super::ADDR_ENDP2>;
#[doc = "Writer for register ADDR_ENDP2"]
pub type W = crate::W<u32, super::ADDR_ENDP2>;
#[doc = "Register ADDR_ENDP2 `reset()`'s with value 0"]
impl crate::ResetValue for super::ADDR_ENDP2 {
    type Type = u32;
    #[inline(always)]
