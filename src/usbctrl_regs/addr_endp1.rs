...
pub type ADDRESS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ADDR_ENDP1_SPEC, u8, u8, 7, O>;
...
pub type ENDPOINT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ADDR_ENDP1_SPEC, u8, u8, 4, O>;
...
pub type INTEP_DIR_W<'a, const O: u8> = crate::BitWriter<'a, u32, ADDR_ENDP1_SPEC, bool, O>;
...
pub type INTEP_PREAMBLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, ADDR_ENDP1_SPEC, bool, O>;
impl R {
