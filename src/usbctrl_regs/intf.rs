...
pub type HOST_CONN_DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_RESUME_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type HOST_SOF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type TRANS_COMPLETE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type BUFF_STATUS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ERROR_DATA_SEQ_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ERROR_RX_TIMEOUT_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ERROR_RX_OVERFLOW_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ERROR_BIT_STUFF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ERROR_CRC_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type BUS_RESET_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DEV_CONN_DIS_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DEV_SUSPEND_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DEV_RESUME_FROM_HOST_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type SETUP_REQ_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type DEV_SOF_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type ABORT_DONE_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type EP_STALL_NAK_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn host_conn_dis(&mut self) -> HOST_CONN_DIS_W<INTF_SPEC, 0> {
        HOST_CONN_DIS_W::new(self)
    }
    #[doc = "Bit 1 - Host: raised when a device wakes up the host. Cleared by writing to SIE_STATUS.RESUME"]
    #[inline(always)]
    #[must_use]
    pub fn host_resume(&mut self) -> HOST_RESUME_W<INTF_SPEC, 1> {
        HOST_RESUME_W::new(self)
    }
    #[doc = "Bit 2 - Host: raised every time the host sends a SOF (Start of Frame). Cleared by reading SOF_RD"]
    #[inline(always)]
    #[must_use]
    pub fn host_sof(&mut self) -> HOST_SOF_W<INTF_SPEC, 2> {
        HOST_SOF_W::new(self)
    }
    #[doc = "Bit 3 - Raised every time SIE_STATUS.TRANS_COMPLETE is set. Clear by writing to this bit."]
    #[inline(always)]
    #[must_use]
    pub fn trans_complete(&mut self) -> TRANS_COMPLETE_W<INTF_SPEC, 3> {
        TRANS_COMPLETE_W::new(self)
    }
    #[doc = "Bit 4 - Raised when any bit in BUFF_STATUS is set. Clear by clearing all bits in BUFF_STATUS."]
    #[inline(always)]
    #[must_use]
    pub fn buff_status(&mut self) -> BUFF_STATUS_W<INTF_SPEC, 4> {
        BUFF_STATUS_W::new(self)
    }
    #[doc = "Bit 5 - Source: SIE_STATUS.DATA_SEQ_ERROR"]
    #[inline(always)]
    #[must_use]
    pub fn error_data_seq(&mut self) -> ERROR_DATA_SEQ_W<INTF_SPEC, 5> {
        ERROR_DATA_SEQ_W::new(self)
    }
    #[doc = "Bit 6 - Source: SIE_STATUS.RX_TIMEOUT"]
    #[inline(always)]
    #[must_use]
    pub fn error_rx_timeout(&mut self) -> ERROR_RX_TIMEOUT_W<INTF_SPEC, 6> {
        ERROR_RX_TIMEOUT_W::new(self)
    }
    #[doc = "Bit 7 - Source: SIE_STATUS.RX_OVERFLOW"]
    #[inline(always)]
    #[must_use]
    pub fn error_rx_overflow(&mut self) -> ERROR_RX_OVERFLOW_W<INTF_SPEC, 7> {
        ERROR_RX_OVERFLOW_W::new(self)
    }
    #[doc = "Bit 8 - Source: SIE_STATUS.BIT_STUFF_ERROR"]
    #[inline(always)]
    #[must_use]
    pub fn error_bit_stuff(&mut self) -> ERROR_BIT_STUFF_W<INTF_SPEC, 8> {
        ERROR_BIT_STUFF_W::new(self)
    }
    #[doc = "Bit 9 - Source: SIE_STATUS.CRC_ERROR"]
    #[inline(always)]
    #[must_use]
    pub fn error_crc(&mut self) -> ERROR_CRC_W<INTF_SPEC, 9> {
        ERROR_CRC_W::new(self)
    }
    #[doc = "Bit 10 - Source: SIE_STATUS.STALL_REC"]
    #[inline(always)]
    #[must_use]
    pub fn stall(&mut self) -> STALL_W<INTF_SPEC, 10> {
        STALL_W::new(self)
    }
    #[doc = "Bit 11 - Source: SIE_STATUS.VBUS_DETECTED"]
    #[inline(always)]
    #[must_use]
    pub fn vbus_detect(&mut self) -> VBUS_DETECT_W<INTF_SPEC, 11> {
        VBUS_DETECT_W::new(self)
    }
    #[doc = "Bit 12 - Source: SIE_STATUS.BUS_RESET"]
    #[inline(always)]
    #[must_use]
    pub fn bus_reset(&mut self) -> BUS_RESET_W<INTF_SPEC, 12> {
        BUS_RESET_W::new(self)
    }
    #[doc = "Bit 13 - Set when the device connection state changes. Cleared by writing to SIE_STATUS.CONNECTED"]
    #[inline(always)]
    #[must_use]
    pub fn dev_conn_dis(&mut self) -> DEV_CONN_DIS_W<INTF_SPEC, 13> {
        DEV_CONN_DIS_W::new(self)
    }
    #[doc = "Bit 14 - Set when the device suspend state changes. Cleared by writing to SIE_STATUS.SUSPENDED"]
    #[inline(always)]
    #[must_use]
    pub fn dev_suspend(&mut self) -> DEV_SUSPEND_W<INTF_SPEC, 14> {
        DEV_SUSPEND_W::new(self)
    }
    #[doc = "Bit 15 - Set when the device receives a resume from the host. Cleared by writing to SIE_STATUS.RESUME"]
    #[inline(always)]
    #[must_use]
    pub fn dev_resume_from_host(&mut self) -> DEV_RESUME_FROM_HOST_W<INTF_SPEC, 15> {
        DEV_RESUME_FROM_HOST_W::new(self)
    }
    #[doc = "Bit 16 - Device. Source: SIE_STATUS.SETUP_REC"]
    #[inline(always)]
    #[must_use]
    pub fn setup_req(&mut self) -> SETUP_REQ_W<INTF_SPEC, 16> {
        SETUP_REQ_W::new(self)
    }
    #[doc = "Bit 17 - Set every time the device receives a SOF (Start of Frame) packet. Cleared by reading SOF_RD"]
    #[inline(always)]
    #[must_use]
    pub fn dev_sof(&mut self) -> DEV_SOF_W<INTF_SPEC, 17> {
        DEV_SOF_W::new(self)
    }
    #[doc = "Bit 18 - Raised when any bit in ABORT_DONE is set. Clear by clearing all bits in ABORT_DONE."]
    #[inline(always)]
    #[must_use]
    pub fn abort_done(&mut self) -> ABORT_DONE_W<INTF_SPEC, 18> {
        ABORT_DONE_W::new(self)
    }
    #[doc = "Bit 19 - Raised when any bit in EP_STATUS_STALL_NAK is set. Clear by clearing all bits in EP_STATUS_STALL_NAK."]
    #[inline(always)]
    #[must_use]
    pub fn ep_stall_nak(&mut self) -> EP_STALL_NAK_W<INTF_SPEC, 19> {
