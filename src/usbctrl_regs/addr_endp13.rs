#[doc = "Register `ADDR_ENDP13` reader"]
pub struct R(crate::R<ADDR_ENDP13_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<ADDR_ENDP13_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<ADDR_ENDP13_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<ADDR_ENDP13_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `ADDR_ENDP13` writer"]
pub struct W(crate::W<ADDR_ENDP13_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<ADDR_ENDP13_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<ADDR_ENDP13_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<ADDR_ENDP13_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type ADDRESS_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ADDR_ENDP13_SPEC, u8, u8, 7, O>;
...
pub type ENDPOINT_W<'a, const O: u8> = crate::FieldWriter<'a, u32, ADDR_ENDP13_SPEC, u8, u8, 4, O>;
...
pub type INTEP_DIR_W<'a, const O: u8> = crate::BitWriter<'a, u32, ADDR_ENDP13_SPEC, bool, O>;
...
pub type INTEP_PREAMBLE_W<'a, const O: u8> = crate::BitWriter<'a, u32, ADDR_ENDP13_SPEC, bool, O>;
impl R {
...
For information about available fields see [addr_endp13](index.html) module"]
pub struct ADDR_ENDP13_SPEC;
impl crate::RegisterSpec for ADDR_ENDP13_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [addr_endp13::R](R) reader structure"]
impl crate::Readable for ADDR_ENDP13_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [addr_endp13::W](W) writer structure"]
impl crate::Writable for ADDR_ENDP13_SPEC {
    type Writer = W;
    const ZERO_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
    const ONE_TO_MODIFY_FIELDS_BITMAP: Self::Ux = 0;
}
#[doc = "`reset()` method sets ADDR_ENDP13 to value 0"]
impl crate::Resettable for ADDR_ENDP13_SPEC {
