#[doc = "Register `SPINLOCK10` reader"]
pub struct R(crate::R<SPINLOCK10_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SPINLOCK10_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SPINLOCK10_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPINLOCK10_SPEC>) -> Self {
        R(reader)
    }
}
...
impl crate::RegisterSpec for SPINLOCK10_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [spinlock10::R](R) reader structure"]
