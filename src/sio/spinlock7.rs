...
#[doc = "Register `SPINLOCK7` writer"]
pub struct W(crate::W<SPINLOCK7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPINLOCK7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPINLOCK7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPINLOCK7_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [spinlock7::W](W) writer structure"]
impl crate::Writable for SPINLOCK7_SPEC {
    type Writer = W;
}
