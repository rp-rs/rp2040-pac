...
pub type INTERP0_ACCUM0_ADD_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 24, O, u32>;
impl R {
    #[doc = "Bits 0:23"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn interp0_accum0_add(&mut self) -> INTERP0_ACCUM0_ADD_W<INTERP0_ACCUM0_ADD_SPEC, 0> {
