...
#[doc = "Register `SPINLOCK20` writer"]
pub struct W(crate::W<SPINLOCK20_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPINLOCK20_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPINLOCK20_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPINLOCK20_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [spinlock20::W](W) writer structure"]
impl crate::Writable for SPINLOCK20_SPEC {
    type Writer = W;
}
