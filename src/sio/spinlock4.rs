...
impl From<crate::R<SPINLOCK4_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPINLOCK4_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPINLOCK4` writer"]
pub struct W(crate::W<SPINLOCK4_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPINLOCK4_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPINLOCK4_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPINLOCK4_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [spinlock4::W](W) writer structure"]
impl crate::Writable for SPINLOCK4_SPEC {
    type Writer = W;
}
