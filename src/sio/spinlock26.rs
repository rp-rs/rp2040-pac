...
impl From<crate::R<SPINLOCK26_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPINLOCK26_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPINLOCK26` writer"]
pub struct W(crate::W<SPINLOCK26_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPINLOCK26_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPINLOCK26_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPINLOCK26_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [spinlock26::W](W) writer structure"]
impl crate::Writable for SPINLOCK26_SPEC {
    type Writer = W;
}
