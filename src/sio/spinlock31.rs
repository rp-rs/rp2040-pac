...
#[doc = "Register `SPINLOCK31` writer"]
pub struct W(crate::W<SPINLOCK31_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPINLOCK31_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPINLOCK31_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPINLOCK31_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [spinlock31::W](W) writer structure"]
impl crate::Writable for SPINLOCK31_SPEC {
    type Writer = W;
}
