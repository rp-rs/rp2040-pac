...
pub struct R(crate::R<INTERP0_PEEK_FULL_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INTERP0_PEEK_FULL_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INTERP0_PEEK_FULL_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INTERP0_PEEK_FULL_SPEC>) -> Self {
        R(reader)
    }
}
...
impl core::fmt::Debug for crate::generic::Reg<INTERP0_PEEK_FULL_SPEC> {
...
For information about available fields see [interp0_peek_full](index.html) module"]
