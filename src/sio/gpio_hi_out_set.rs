...
pub struct R(crate::R<GPIO_HI_OUT_SET_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO_HI_OUT_SET_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIO_HI_OUT_SET_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIO_HI_OUT_SET_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Field `GPIO_HI_OUT_SET` reader - Perform an atomic bit-set on GPIO_HI_OUT, i.e. `GPIO_HI_OUT |= wdata`"]
pub struct GPIO_HI_OUT_SET_R(crate::FieldReader<u8, u8>);
impl GPIO_HI_OUT_SET_R {
    pub(crate) fn new(bits: u8) -> Self {
        GPIO_HI_OUT_SET_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GPIO_HI_OUT_SET_R {
