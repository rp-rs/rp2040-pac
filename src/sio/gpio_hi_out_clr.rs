...
pub struct R(crate::R<GPIO_HI_OUT_CLR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO_HI_OUT_CLR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIO_HI_OUT_CLR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIO_HI_OUT_CLR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Field `GPIO_HI_OUT_CLR` reader - Perform an atomic bit-clear on GPIO_HI_OUT, i.e. `GPIO_HI_OUT &= ~wdata`"]
pub struct GPIO_HI_OUT_CLR_R(crate::FieldReader<u8, u8>);
impl GPIO_HI_OUT_CLR_R {
    pub(crate) fn new(bits: u8) -> Self {
        GPIO_HI_OUT_CLR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GPIO_HI_OUT_CLR_R {
...
pub struct GPIO_HI_OUT_CLR_W<'a> {
    w: &'a mut W,
}
impl<'a> GPIO_HI_OUT_CLR_W<'a> {
...
impl R {
    ...
    #[inline(always)]
    pub fn gpio_hi_out_clr(&self) -> GPIO_HI_OUT_CLR_R {
        GPIO_HI_OUT_CLR_R::new((self.bits & 0x3f) as u8)
    }
}
impl W {
    #[doc = "Bits 0:5 - Perform an atomic bit-clear on GPIO_HI_OUT, i.e. `GPIO_HI_OUT &= ~wdata`"]
    #[inline(always)]
    pub fn gpio_hi_out_clr(&mut self) -> GPIO_HI_OUT_CLR_W {
        GPIO_HI_OUT_CLR_W { w: self }
    }
