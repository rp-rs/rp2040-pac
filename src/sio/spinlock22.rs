...
#[doc = "Register `SPINLOCK22` writer"]
pub struct W(crate::W<SPINLOCK22_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPINLOCK22_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPINLOCK22_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPINLOCK22_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [spinlock22::W](W) writer structure"]
impl crate::Writable for SPINLOCK22_SPEC {
    type Writer = W;
}
