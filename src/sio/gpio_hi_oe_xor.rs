...
pub struct R(crate::R<GPIO_HI_OE_XOR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO_HI_OE_XOR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIO_HI_OE_XOR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIO_HI_OE_XOR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIO_HI_OE_XOR` writer"]
pub struct W(crate::W<GPIO_HI_OE_XOR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO_HI_OE_XOR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPIO_HI_OE_XOR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIO_HI_OE_XOR_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `GPIO_HI_OE_XOR` reader - Perform an atomic bitwise XOR on GPIO_HI_OE, i.e. `GPIO_HI_OE ^= wdata`"]
pub struct GPIO_HI_OE_XOR_R(crate::FieldReader<u8, u8>);
impl GPIO_HI_OE_XOR_R {
    pub(crate) fn new(bits: u8) -> Self {
        GPIO_HI_OE_XOR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GPIO_HI_OE_XOR_R {
...
For information about available fields see [gpio_hi_oe_xor](index.html) module"]
