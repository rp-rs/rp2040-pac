...
#[doc = "Register `SPINLOCK6` writer"]
pub struct W(crate::W<SPINLOCK6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPINLOCK6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPINLOCK6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPINLOCK6_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [spinlock6::W](W) writer structure"]
impl crate::Writable for SPINLOCK6_SPEC {
    type Writer = W;
}
