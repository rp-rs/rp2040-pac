...
pub struct R(crate::R<GPIO_OUT_XOR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO_OUT_XOR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIO_OUT_XOR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIO_OUT_XOR_SPEC>) -> Self {
        R(reader)
    }
}
...
#[doc = "Field `GPIO_OUT_XOR` reader - Perform an atomic bitwise XOR on GPIO_OUT, i.e. `GPIO_OUT ^= wdata`"]
pub struct GPIO_OUT_XOR_R(crate::FieldReader<u32, u32>);
impl GPIO_OUT_XOR_R {
    pub(crate) fn new(bits: u32) -> Self {
        GPIO_OUT_XOR_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for GPIO_OUT_XOR_R {
