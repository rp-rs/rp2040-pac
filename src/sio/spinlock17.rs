...
impl From<crate::R<SPINLOCK17_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SPINLOCK17_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SPINLOCK17` writer"]
pub struct W(crate::W<SPINLOCK17_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPINLOCK17_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPINLOCK17_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPINLOCK17_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [spinlock17::W](W) writer structure"]
impl crate::Writable for SPINLOCK17_SPEC {
    type Writer = W;
}
