...
pub struct R(crate::R<INTERP0_ACCUM1_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INTERP0_ACCUM1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INTERP0_ACCUM1_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INTERP0_ACCUM1_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `INTERP0_ACCUM1` writer"]
pub struct W(crate::W<INTERP0_ACCUM1_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INTERP0_ACCUM1_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<INTERP0_ACCUM1_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INTERP0_ACCUM1_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
For information about available fields see [interp0_accum1](index.html) module"]
