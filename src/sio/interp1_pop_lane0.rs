...
impl core::fmt::Debug for crate::generic::Reg<INTERP1_POP_LANE0_SPEC> {
...
You can [`read`](crate::generic::Reg::read) this register and get [`interp1_pop_lane0::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
