...
pub type INTERP1_ACCUM1_ADD_R = crate::FieldReader<u32, u32>;
#[doc = "Field `INTERP1_ACCUM1_ADD` writer - "]
pub type INTERP1_ACCUM1_ADD_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, INTERP1_ACCUM1_ADD_SPEC, u32, u32, 24, O>;
impl R {
    #[doc = "Bits 0:23"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn interp1_accum1_add(&mut self) -> INTERP1_ACCUM1_ADD_W<0> {
