...
#[doc = "Register `SPINLOCK23` writer"]
pub struct W(crate::W<SPINLOCK23_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SPINLOCK23_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SPINLOCK23_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SPINLOCK23_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
#[doc = "`write(|w| ..)` method takes [spinlock23::W](W) writer structure"]
impl crate::Writable for SPINLOCK23_SPEC {
    type Writer = W;
}
