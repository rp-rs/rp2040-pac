...
pub struct R(crate::R<SCRATCH6_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCRATCH6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCRATCH6_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCRATCH6_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCRATCH6` writer"]
pub struct W(crate::W<SCRATCH6_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCRATCH6_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCRATCH6_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCRATCH6_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
For information about available fields see [scratch6](index.html) module"]
