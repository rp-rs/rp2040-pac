...
pub type PAUSE_JTAG_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PAUSE_DBG0_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
pub type PAUSE_DBG1_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn pause_jtag(&mut self) -> PAUSE_JTAG_W<CTRL_SPEC, 24> {
        PAUSE_JTAG_W::new(self)
    }
    #[doc = "Bit 25 - Pause the watchdog timer when processor 0 is in debug mode"]
    #[inline(always)]
    #[must_use]
    pub fn pause_dbg0(&mut self) -> PAUSE_DBG0_W<CTRL_SPEC, 25> {
        PAUSE_DBG0_W::new(self)
    }
    #[doc = "Bit 26 - Pause the watchdog timer when processor 1 is in debug mode"]
    #[inline(always)]
    #[must_use]
    pub fn pause_dbg1(&mut self) -> PAUSE_DBG1_W<CTRL_SPEC, 26> {
        PAUSE_DBG1_W::new(self)
    }
    #[doc = "Bit 30 - When not enabled the watchdog timer is paused"]
    #[inline(always)]
    #[must_use]
    pub fn enable(&mut self) -> ENABLE_W<CTRL_SPEC, 30> {
        ENABLE_W::new(self)
    }
    #[doc = "Bit 31 - Trigger a watchdog reset"]
    #[inline(always)]
    #[must_use]
    pub fn trigger(&mut self) -> TRIGGER_W<CTRL_SPEC, 31> {
        TRIGGER_W::new(self)
    }
