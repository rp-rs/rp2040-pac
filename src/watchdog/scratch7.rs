...
pub struct R(crate::R<SCRATCH7_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCRATCH7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCRATCH7_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCRATCH7_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCRATCH7` writer"]
pub struct W(crate::W<SCRATCH7_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCRATCH7_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCRATCH7_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCRATCH7_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
For information about available fields see [scratch7](index.html) module"]
