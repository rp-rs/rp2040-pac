...
pub struct R(crate::R<SCRATCH3_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SCRATCH3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SCRATCH3_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SCRATCH3_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SCRATCH3` writer"]
pub struct W(crate::W<SCRATCH3_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SCRATCH3_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SCRATCH3_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SCRATCH3_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
For information about available fields see [scratch3](index.html) module"]
