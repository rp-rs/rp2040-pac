...
impl core::fmt::Debug for crate::generic::Reg<CH3_DBG_TCR_SPEC> {
...
You can [`read`](crate::generic::Reg::read) this register and get [`ch3_dbg_tcr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
