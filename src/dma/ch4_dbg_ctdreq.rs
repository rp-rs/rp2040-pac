...
impl From<crate::R<CH4_DBG_CTDREQ_SPEC>> for R {
    #[inline(always)]
...
pub struct W(crate::W<CH4_DBG_CTDREQ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH4_DBG_CTDREQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH4_DBG_CTDREQ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH4_DBG_CTDREQ_SPEC>) -> Self {
        W(writer)
    }
}
...
pub struct CH4_DBG_CTDREQ_W<'a> {
    w: &'a mut W,
}
impl<'a> CH4_DBG_CTDREQ_W<'a> {
...
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn ch4_dbg_ctdreq(&mut self) -> CH4_DBG_CTDREQ_W {
        CH4_DBG_CTDREQ_W { w: self }
    }
