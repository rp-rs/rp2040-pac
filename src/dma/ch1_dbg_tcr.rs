...
impl core::fmt::Debug for crate::generic::Reg<CH1_DBG_TCR_SPEC> {
...
You can [`read`](crate::generic::Reg::read) this register and get [`ch1_dbg_tcr::R`](R).  See [API](https://docs.rs/svd2rust/#read--modify--write-api)."]
