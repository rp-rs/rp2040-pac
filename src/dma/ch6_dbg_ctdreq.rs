...
pub struct R(crate::R<CH6_DBG_CTDREQ_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH6_DBG_CTDREQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH6_DBG_CTDREQ_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH6_DBG_CTDREQ_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH6_DBG_CTDREQ` writer"]
pub struct W(crate::W<CH6_DBG_CTDREQ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH6_DBG_CTDREQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH6_DBG_CTDREQ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH6_DBG_CTDREQ_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CH6_DBG_CTDREQ` reader - "]
pub struct CH6_DBG_CTDREQ_R(crate::FieldReader<u8, u8>);
impl CH6_DBG_CTDREQ_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CH6_DBG_CTDREQ_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CH6_DBG_CTDREQ_R {
...
pub struct CH6_DBG_CTDREQ_W<'a> {
    w: &'a mut W,
}
impl<'a> CH6_DBG_CTDREQ_W<'a> {
...
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn ch6_dbg_ctdreq(&mut self) -> CH6_DBG_CTDREQ_W {
        CH6_DBG_CTDREQ_W { w: self }
    }
...
For information about available fields see [ch6_dbg_ctdreq](index.html) module"]
