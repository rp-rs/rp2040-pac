...
pub type CH6_DBG_CTDREQ_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CH6_DBG_CTDREQ` writer - "]
pub type CH6_DBG_CTDREQ_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH6_DBG_CTDREQ_SPEC, u8, u8, 6, O>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch6_dbg_ctdreq(&mut self) -> CH6_DBG_CTDREQ_W<0> {
        CH6_DBG_CTDREQ_W::new(self)
    }
