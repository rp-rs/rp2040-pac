...
pub struct W(crate::W<CH7_DBG_CTDREQ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH7_DBG_CTDREQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH7_DBG_CTDREQ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH7_DBG_CTDREQ_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CH7_DBG_CTDREQ` reader - "]
pub type CH7_DBG_CTDREQ_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CH7_DBG_CTDREQ` writer - "]
pub type CH7_DBG_CTDREQ_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH7_DBG_CTDREQ_SPEC, u8, u8, 6, O>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch7_dbg_ctdreq(&mut self) -> CH7_DBG_CTDREQ_W<0> {
        CH7_DBG_CTDREQ_W::new(self)
    }
