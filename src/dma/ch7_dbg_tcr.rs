...
pub struct R(crate::R<CH7_DBG_TCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH7_DBG_TCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH7_DBG_TCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH7_DBG_TCR_SPEC>) -> Self {
        R(reader)
    }
}
...
impl core::fmt::Debug for crate::generic::Reg<CH7_DBG_TCR_SPEC> {
...
For information about available fields see [ch7_dbg_tcr](index.html) module"]
