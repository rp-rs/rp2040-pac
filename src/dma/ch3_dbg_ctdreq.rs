...
pub struct W(crate::W<CH3_DBG_CTDREQ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH3_DBG_CTDREQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH3_DBG_CTDREQ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH3_DBG_CTDREQ_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CH3_DBG_CTDREQ` reader - "]
pub type CH3_DBG_CTDREQ_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CH3_DBG_CTDREQ` writer - "]
pub type CH3_DBG_CTDREQ_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH3_DBG_CTDREQ_SPEC, u8, u8, 6, O>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch3_dbg_ctdreq(&mut self) -> CH3_DBG_CTDREQ_W<0> {
        CH3_DBG_CTDREQ_W::new(self)
    }
