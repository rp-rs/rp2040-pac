...
pub type CH0_DBG_CTDREQ_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CH0_DBG_CTDREQ` writer - "]
pub type CH0_DBG_CTDREQ_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH0_DBG_CTDREQ_SPEC, u8, u8, 6, O>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch0_dbg_ctdreq(&mut self) -> CH0_DBG_CTDREQ_W<0> {
