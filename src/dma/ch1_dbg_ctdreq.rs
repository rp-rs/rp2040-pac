...
pub struct CH1_DBG_CTDREQ_R(crate::FieldReader<u8, u8>);
impl CH1_DBG_CTDREQ_R {
    #[inline(always)]
    pub(crate) fn new(bits: u8) -> Self {
        CH1_DBG_CTDREQ_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CH1_DBG_CTDREQ_R {
...
pub struct CH1_DBG_CTDREQ_W<'a> {
    w: &'a mut W,
}
impl<'a> CH1_DBG_CTDREQ_W<'a> {
...
impl W {
    #[doc = "Bits 0:5"]
    #[inline(always)]
    pub fn ch1_dbg_ctdreq(&mut self) -> CH1_DBG_CTDREQ_W {
        CH1_DBG_CTDREQ_W { w: self }
    }
