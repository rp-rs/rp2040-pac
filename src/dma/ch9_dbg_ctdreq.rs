...
pub struct W(crate::W<CH9_DBG_CTDREQ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH9_DBG_CTDREQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH9_DBG_CTDREQ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH9_DBG_CTDREQ_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `CH9_DBG_CTDREQ` reader - "]
pub type CH9_DBG_CTDREQ_R = crate::FieldReader<u8, u8>;
#[doc = "Field `CH9_DBG_CTDREQ` writer - "]
pub type CH9_DBG_CTDREQ_W<'a, const O: u8> =
    crate::FieldWriter<'a, u32, CH9_DBG_CTDREQ_SPEC, u8, u8, 6, O>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch9_dbg_ctdreq(&mut self) -> CH9_DBG_CTDREQ_W<0> {
        CH9_DBG_CTDREQ_W::new(self)
    }
