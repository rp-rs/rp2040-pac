...
pub struct R(crate::R<CH11_DBG_TCR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH11_DBG_TCR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH11_DBG_TCR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH11_DBG_TCR_SPEC>) -> Self {
        R(reader)
    }
}
...
impl core::fmt::Debug for crate::generic::Reg<CH11_DBG_TCR_SPEC> {
...
For information about available fields see [ch11_dbg_tcr](index.html) module"]
