...
pub type CH8_DBG_CTDREQ_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch8_dbg_ctdreq(&mut self) -> CH8_DBG_CTDREQ_W<CH8_DBG_CTDREQ_SPEC, 0> {
        CH8_DBG_CTDREQ_W::new(self)
    }
