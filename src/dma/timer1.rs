...
pub type Y_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
...
pub type X_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 16, O, u16>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn y(&mut self) -> Y_W<TIMER1_SPEC, 0> {
        Y_W::new(self)
    }
    #[doc = "Bits 16:31 - Pacing Timer Dividend. Specifies the X value for the (X/Y) fractional timer."]
    #[inline(always)]
    #[must_use]
    pub fn x(&mut self) -> X_W<TIMER1_SPEC, 16> {
        X_W::new(self)
    }
