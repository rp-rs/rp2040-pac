...
pub struct R(crate::R<CH_AL2_TRANS_COUNT_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH_AL2_TRANS_COUNT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH_AL2_TRANS_COUNT_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH_AL2_TRANS_COUNT_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH_AL2_TRANS_COUNT` writer"]
pub struct W(crate::W<CH_AL2_TRANS_COUNT_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH_AL2_TRANS_COUNT_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH_AL2_TRANS_COUNT_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH_AL2_TRANS_COUNT_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
For information about available fields see [ch_al2_trans_count](index.html) module"]
