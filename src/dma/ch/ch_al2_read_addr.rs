...
pub struct W(crate::W<CH_AL2_READ_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH_AL2_READ_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH_AL2_READ_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH_AL2_READ_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
