...
pub struct R(crate::R<CH_AL1_READ_ADDR_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<CH_AL1_READ_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<CH_AL1_READ_ADDR_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<CH_AL1_READ_ADDR_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `CH_AL1_READ_ADDR` writer"]
pub struct W(crate::W<CH_AL1_READ_ADDR_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH_AL1_READ_ADDR_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH_AL1_READ_ADDR_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH_AL1_READ_ADDR_SPEC>) -> Self {
        W(writer)
    }
}
impl W {
...
For information about available fields see [ch_al1_read_addr](index.html) module"]
