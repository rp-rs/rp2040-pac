...
pub struct W(crate::W<CH_AL1_TRANS_COUNT_TRIG_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH_AL1_TRANS_COUNT_TRIG_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH_AL1_TRANS_COUNT_TRIG_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH_AL1_TRANS_COUNT_TRIG_SPEC>) -> Self {
        W(writer)
    }
}
...
impl core::fmt::Debug for crate::generic::Reg<CH_AL1_TRANS_COUNT_TRIG_SPEC> {
