...
pub struct W(crate::W<CH10_DBG_CTDREQ_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<CH10_DBG_CTDREQ_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<CH10_DBG_CTDREQ_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<CH10_DBG_CTDREQ_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type CH10_DBG_CTDREQ_W<'a, const O: u8> = crate::FieldWriter<'a, CH10_DBG_CTDREQ_SPEC, 6, O>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
