...
pub type CH10_DBG_CTDREQ_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 6, O>;
impl R {
    #[doc = "Bits 0:5"]
    #[inline(always)]
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ch10_dbg_ctdreq(&mut self) -> CH10_DBG_CTDREQ_W<CH10_DBG_CTDREQ_SPEC, 0> {
