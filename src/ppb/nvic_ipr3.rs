...
pub type IP_12_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type IP_13_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type IP_14_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type IP_15_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ip_12(&mut self) -> IP_12_W<NVIC_IPR3_SPEC, 6> {
        IP_12_W::new(self)
    }
    #[doc = "Bits 14:15 - Priority of interrupt 13"]
    #[inline(always)]
    #[must_use]
    pub fn ip_13(&mut self) -> IP_13_W<NVIC_IPR3_SPEC, 14> {
        IP_13_W::new(self)
    }
    #[doc = "Bits 22:23 - Priority of interrupt 14"]
    #[inline(always)]
    #[must_use]
    pub fn ip_14(&mut self) -> IP_14_W<NVIC_IPR3_SPEC, 22> {
        IP_14_W::new(self)
    }
    #[doc = "Bits 30:31 - Priority of interrupt 15"]
    #[inline(always)]
    #[must_use]
    pub fn ip_15(&mut self) -> IP_15_W<NVIC_IPR3_SPEC, 30> {
        IP_15_W::new(self)
    }
