...
pub type IP_0_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type IP_1_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type IP_2_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type IP_3_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ip_0(&mut self) -> IP_0_W<NVIC_IPR0_SPEC, 6> {
        IP_0_W::new(self)
    }
    #[doc = "Bits 14:15 - Priority of interrupt 1"]
    #[inline(always)]
    #[must_use]
    pub fn ip_1(&mut self) -> IP_1_W<NVIC_IPR0_SPEC, 14> {
        IP_1_W::new(self)
    }
    #[doc = "Bits 22:23 - Priority of interrupt 2"]
    #[inline(always)]
    #[must_use]
    pub fn ip_2(&mut self) -> IP_2_W<NVIC_IPR0_SPEC, 22> {
        IP_2_W::new(self)
    }
    #[doc = "Bits 30:31 - Priority of interrupt 3"]
    #[inline(always)]
    #[must_use]
    pub fn ip_3(&mut self) -> IP_3_W<NVIC_IPR0_SPEC, 30> {
        IP_3_W::new(self)
    }
