...
pub type IP_8_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type IP_9_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type IP_10_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
...
pub type IP_11_W<'a, REG, const O: u8> = crate::FieldWriter<'a, REG, 2, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ip_8(&mut self) -> IP_8_W<NVIC_IPR2_SPEC, 6> {
        IP_8_W::new(self)
    }
    #[doc = "Bits 14:15 - Priority of interrupt 9"]
    #[inline(always)]
    #[must_use]
    pub fn ip_9(&mut self) -> IP_9_W<NVIC_IPR2_SPEC, 14> {
        IP_9_W::new(self)
    }
    #[doc = "Bits 22:23 - Priority of interrupt 10"]
    #[inline(always)]
    #[must_use]
    pub fn ip_10(&mut self) -> IP_10_W<NVIC_IPR2_SPEC, 22> {
        IP_10_W::new(self)
    }
    #[doc = "Bits 30:31 - Priority of interrupt 11"]
    #[inline(always)]
    #[must_use]
    pub fn ip_11(&mut self) -> IP_11_W<NVIC_IPR2_SPEC, 30> {
        IP_11_W::new(self)
    }
