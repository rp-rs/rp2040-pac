...
pub type SSI_EN_W<'a, REG, const O: u8> = crate::BitWriter<'a, REG, O>;
impl R {
...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn ssi_en(&mut self) -> SSI_EN_W<SSIENR_SPEC, 0> {
        SSI_EN_W::new(self)
    }
