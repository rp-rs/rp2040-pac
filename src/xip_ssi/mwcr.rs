...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn mwmod(&mut self) -> MWMOD_W<MWCR_SPEC, 0> {
        MWMOD_W::new(self)
    }
    #[doc = "Bit 1 - Microwire control"]
    #[inline(always)]
    #[must_use]
    pub fn mdd(&mut self) -> MDD_W<MWCR_SPEC, 1> {
        MDD_W::new(self)
    }
    #[doc = "Bit 2 - Microwire handshaking"]
    #[inline(always)]
    #[must_use]
    pub fn mhs(&mut self) -> MHS_W<MWCR_SPEC, 2> {
        MHS_W::new(self)
    }
