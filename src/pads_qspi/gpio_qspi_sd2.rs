...
pub struct R(crate::R<GPIO_QSPI_SD2_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<GPIO_QSPI_SD2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<GPIO_QSPI_SD2_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<GPIO_QSPI_SD2_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `GPIO_QSPI_SD2` writer"]
pub struct W(crate::W<GPIO_QSPI_SD2_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<GPIO_QSPI_SD2_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<GPIO_QSPI_SD2_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<GPIO_QSPI_SD2_SPEC>) -> Self {
        W(writer)
    }
}
...
pub type SLEWFAST_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_QSPI_SD2_SPEC, bool, O>;
...
pub type SCHMITT_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_QSPI_SD2_SPEC, bool, O>;
#[doc = "Field `PDE` reader - Pull down enable"]
pub type PDE_R = crate::BitReader<bool>;
#[doc = "Field `PDE` writer - Pull down enable"]
pub type PDE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_QSPI_SD2_SPEC, bool, O>;
#[doc = "Field `PUE` reader - Pull up enable"]
pub type PUE_R = crate::BitReader<bool>;
#[doc = "Field `PUE` writer - Pull up enable"]
pub type PUE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_QSPI_SD2_SPEC, bool, O>;
...
pub type DRIVE_W<'a, const O: u8> =
    crate::FieldWriterSafe<'a, u32, GPIO_QSPI_SD2_SPEC, u8, DRIVE_A, 2, O>;
...
pub type IE_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_QSPI_SD2_SPEC, bool, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, u32, GPIO_QSPI_SD2_SPEC, bool, O>;
impl R {
...
For information about available fields see [gpio_qspi_sd2](index.html) module"]
