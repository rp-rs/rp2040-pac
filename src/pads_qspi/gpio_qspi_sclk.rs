...
impl W {
    ...
    #[inline(always)]
    #[must_use]
    pub fn slewfast(&mut self) -> SLEWFAST_W<GPIO_QSPI_SCLK_SPEC, 0> {
        SLEWFAST_W::new(self)
    }
    #[doc = "Bit 1 - Enable schmitt trigger"]
    #[inline(always)]
    #[must_use]
    pub fn schmitt(&mut self) -> SCHMITT_W<GPIO_QSPI_SCLK_SPEC, 1> {
        SCHMITT_W::new(self)
    }
    #[doc = "Bit 2 - Pull down enable"]
    #[inline(always)]
    #[must_use]
    pub fn pde(&mut self) -> PDE_W<GPIO_QSPI_SCLK_SPEC, 2> {
        PDE_W::new(self)
    }
    #[doc = "Bit 3 - Pull up enable"]
    #[inline(always)]
    #[must_use]
    pub fn pue(&mut self) -> PUE_W<GPIO_QSPI_SCLK_SPEC, 3> {
        PUE_W::new(self)
    }
    #[doc = "Bits 4:5 - Drive strength."]
    #[inline(always)]
    #[must_use]
    pub fn drive(&mut self) -> DRIVE_W<GPIO_QSPI_SCLK_SPEC, 4> {
        DRIVE_W::new(self)
    }
    #[doc = "Bit 6 - Input enable"]
    #[inline(always)]
    #[must_use]
    pub fn ie(&mut self) -> IE_W<GPIO_QSPI_SCLK_SPEC, 6> {
        IE_W::new(self)
    }
    #[doc = "Bit 7 - Output disable. Has priority over output enable from peripherals"]
    #[inline(always)]
    #[must_use]
    pub fn od(&mut self) -> OD_W<GPIO_QSPI_SCLK_SPEC, 7> {
        OD_W::new(self)
    }
