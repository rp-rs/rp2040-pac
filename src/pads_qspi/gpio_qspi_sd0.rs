...
pub type SLEWFAST_W<'a, const O: u8> = crate::BitWriter<'a, GPIO_QSPI_SD0_SPEC, O>;
...
pub type DRIVE_W<'a, const O: u8> = crate::FieldWriterSafe<'a, GPIO_QSPI_SD0_SPEC, 2, O, DRIVE_A>;
...
pub type IE_W<'a, const O: u8> = crate::BitWriter<'a, GPIO_QSPI_SD0_SPEC, O>;
...
pub type OD_W<'a, const O: u8> = crate::BitWriter<'a, GPIO_QSPI_SD0_SPEC, O>;
impl R {
